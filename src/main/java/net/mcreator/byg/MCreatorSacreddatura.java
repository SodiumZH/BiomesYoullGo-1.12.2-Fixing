 ...
 public class MCreatorSacreddatura
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:sacreddatura")
   public static final Block block = null;
   
   public MCreatorSacreddatura(Elementsbyg instance) {
     super(instance, 78);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:sacreddatura", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.6F);
       setUnlocalizedName("sacreddatura");
       setRegistryName("sacreddatura");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSacreddatura.class
