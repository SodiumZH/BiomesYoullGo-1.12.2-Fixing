 ...
 public class MCreatorCaliforniapoppy
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:californiapoppy")
   public static final Block block = null;
   
   public MCreatorCaliforniapoppy(Elementsbyg instance) {
     super(instance, 83);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:californiapoppy", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("californiapoppy");
       setRegistryName("californiapoppy");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCaliforniapoppy.class
