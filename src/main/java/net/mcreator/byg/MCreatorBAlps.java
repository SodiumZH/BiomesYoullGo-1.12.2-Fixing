 ...
 public class MCreatorBAlps
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:balps")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBAlps(Elementsbyg instance) {
     super(instance, 185);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Alps")).setRainfall(0.5F).setBaseHeight(6.0F).setWaterColor(-3342337).setHeightVariation(1.0F)
           .setTemperature(-0.5F));
       setRegistryName("balps");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBAlps.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Blocks.SNOW.getDefaultState().getBlock() && ground != Blocks.SNOW.getDefaultState().getBlock()) || (ground2 != Blocks.SNOW
           .getDefaultState().getBlock() && ground2 != Blocks.SNOW.getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Blocks.SNOW.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Blocks.SNOW.getDefaultState().getBlock() || blockType == Blocks.SNOW
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Blocks.SNOW.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Blocks.SNOW.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBAlps.class
