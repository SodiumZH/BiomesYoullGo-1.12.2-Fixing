 ...
 public class MCreatorRed_crystal_block
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:red_crystal_block")
   public static final Block block = null;
   
   public MCreatorRed_crystal_block(Elementsbyg instance) {
     super(instance, 2380);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
       ...
       MCreatorRedcrystalblockBlockDestroyedByPlayer.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRed_crystal_block.class
