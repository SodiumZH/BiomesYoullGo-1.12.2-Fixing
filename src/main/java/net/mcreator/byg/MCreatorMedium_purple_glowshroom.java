 ...
 public class MCreatorMedium_purple_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:medium_purple_glowshroom")
   public static final Block block = null;
   
   public MCreatorMedium_purple_glowshroom(Elementsbyg instance) {
     super(instance, 1318);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:medium_purple_glowshroom", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       ...
       setRegistryName("medium_purple_glowshroom");
       setUnlocalizedName("medium_purple_glowshroom");
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorPurpleglowshroomitem.block, 3));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorMediumpurpleglowshroomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMedium_purple_glowshroom.class
