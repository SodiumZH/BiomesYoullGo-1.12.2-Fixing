 ...
 public class MCreatorMaplelog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:maplelog")
   public static final Block block = null;
   
   public MCreatorMaplelog(Elementsbyg instance) {
     super(instance, 24);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:maplelog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("maplelog");
       setUnlocalizedName("maplelog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMaplelog.class
