 ...
 public class MCreatorStone_pebbles extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stone_pebbles")
   public static final Block block = null;
   
   public MCreatorStone_pebbles(Elementsbyg instance) {
     super(instance, 2374);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStone_pebbles.class
