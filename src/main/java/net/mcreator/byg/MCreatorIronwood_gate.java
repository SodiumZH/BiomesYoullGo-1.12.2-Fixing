 ...
 public class MCreatorIronwood_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:ironwood_gate")
   public static final Block block = null;
   
   public MCreatorIronwood_gate(Elementsbyg instance) {
     super(instance, 2140);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:ironwood_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("ironwood_gate");
       setUnlocalizedName("ironwood_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorIronwoodgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorIronwood_gate.class
