 ...
 public class MCreatorPalm_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:palm_log")
   public static final Block block = null;
   
   public MCreatorPalm_log(Elementsbyg instance) {
     super(instance, 1394);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:palm_log", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPalm_log.class
