 ...
 public class MCreatorNetherfurnace
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:netherfurnace")
   public static final Block block = null;
   
   public MCreatorNetherfurnace(Elementsbyg instance) {
     super(instance, 643);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorNetherfurnaceOnBlockRightclicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorNetherfurnace.class
