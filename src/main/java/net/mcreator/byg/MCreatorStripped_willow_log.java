 ...
 public class MCreatorStripped_willow_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_willow_log")
   public static final Block block = null;
   
   public MCreatorStripped_willow_log(Elementsbyg instance) {
     super(instance, 1539);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_willow_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_willow_log");
       setUnlocalizedName("stripped_willow_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_willow_log.class
