 ...
 public class MCreatorHollylog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:hollylog")
   public static final Block block = null;
   
   public MCreatorHollylog(Elementsbyg instance) {
     super(instance, 738);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:hollylog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("hollylog");
       setUnlocalizedName("hollylog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorHollylog.class
