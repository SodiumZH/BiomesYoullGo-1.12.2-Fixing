 ...
 public class MCreatorBSkyrisHighlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bskyrishighlands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSkyrisHighlands(Elementsbyg instance) {
     super(instance, 183);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.COLD, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.MAGICAL, BiomeDictionary.Type.RARE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Skyris Highlands")).setRainfall(0.6F).setBaseHeight(4.0F).setWaterColor(-4559438).setHeightVariation(1.0F)
           .setTemperature(0.25F));
       setRegistryName("bskyrishighlands");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSkyrisHighlands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSkyrisHighlands.class
