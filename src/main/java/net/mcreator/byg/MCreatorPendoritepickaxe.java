 ...
 public class MCreatorPendoritepickaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pendoritepickaxe")
   public static final Item block = null;
   
   public MCreatorPendoritepickaxe(Elementsbyg instance) {
     super(instance, 518);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemPickaxe(EnumHelper.addToolMaterial("PENDORITEPICKAXE", 5, 1200, 12.0F, 3.0F, 15)) {
         ...
         }).setUnlocalizedName("pendoritepickaxe").setRegistryName("pendoritepickaxe")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPendoritepickaxe.class
