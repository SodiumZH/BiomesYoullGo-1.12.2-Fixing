 ...
 public class MCreatorPinkdaffodil
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pinkdaffodil")
   public static final Block block = null;
   
   public MCreatorPinkdaffodil(Elementsbyg instance) {
     super(instance, 1111);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:pinkdaffodil", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("pinkdaffodil");
       setRegistryName("pinkdaffodil");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPinkdaffodil.class
