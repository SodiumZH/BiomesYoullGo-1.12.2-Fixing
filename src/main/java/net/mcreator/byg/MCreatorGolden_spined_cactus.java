 ...
 public class MCreatorGolden_spined_cactus extends Elementsbyg.ModElement {
   @ObjectHolder("byg:golden_spined_cactus")
   public static final Block block = null;
   
   public MCreatorGolden_spined_cactus(Elementsbyg instance) {
     super(instance, 2349);
   }
           ...
           public boolean generate(World world, Random random, BlockPos pos) {
             for (int i = 0; i < 20; i++) {
               ...
               if (world.isAirBlock(blockpos1)) {
                 ...
                 j = Math.min(1, j);
                 for (int k = 0; k < j; k++) {
                   if (((BlockReed)MCreatorGolden_spined_cactus.block).canBlockStay(world, blockpos1))
                     world.setBlockState(blockpos1.up(k), MCreatorGolden_spined_cactus.block.getDefaultState(), 2); 
                 } 
               } 
             }  return true;
           }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == MCreatorGolden_spined_cactus.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       if ((world.getBlockState(pos.down()).getBlock() == MCreatorGolden_spined_cactus.block || checkForDrop(world, pos, state)) && 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorGolden_spined_cactus.class
