 ...
 public class MCreatorBNorthernForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bnorthernforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBNorthernForest(Elementsbyg instance) {
     super(instance, 2328);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.RARE, BiomeDictionary.Type.CONIFEROUS });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Northern Forest")).setRainfall(0.5F).setBaseHeight(0.8F).setWaterColor(-14329397)
           .setHeightVariation(0.15F).setTemperature(-0.5F));
       setRegistryName("bnorthernforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBNorthernForest.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random par2Random, BlockPos pos) {
       if (world.isRemote)
         return false; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "northern_tree4"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBNorthernForest.class
