 ...
 public class MCreatorWitch_hazel_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:witch_hazel_gate")
   public static final Block block = null;
   
   public MCreatorWitch_hazel_gate(Elementsbyg instance) {
     super(instance, 2165);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:witch_hazel_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("witch_hazel_gate");
       setUnlocalizedName("witch_hazel_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorWitchhazelgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWitch_hazel_gate.class
