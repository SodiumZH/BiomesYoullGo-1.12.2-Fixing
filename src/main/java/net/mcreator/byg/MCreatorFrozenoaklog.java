 ...
 public class MCreatorFrozenoaklog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:frozenoaklog")
   public static final Block block = null;
   
   public MCreatorFrozenoaklog(Elementsbyg instance) {
     super(instance, 27);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:frozenoaklog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("frozenoaklog");
       setUnlocalizedName("frozenoaklog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFrozenoaklog.class
