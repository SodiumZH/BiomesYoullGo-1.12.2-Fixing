 ...
 public class MCreatorFrozen_oak_sapling
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:frozen_oak_sapling")
   public static final Block block = null;
   
   public MCreatorFrozen_oak_sapling(Elementsbyg instance) {
     super(instance, 2387);
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorFrozenoaksaplingUpdateTick.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorFrozenoaksaplingPlantRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFrozen_oak_sapling.class
