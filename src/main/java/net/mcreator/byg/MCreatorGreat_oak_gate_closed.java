 ...
 public class MCreatorGreat_oak_gate_closed extends Elementsbyg.ModElement {
   @ObjectHolder("byg:great_oak_gate_closed")
   public static final Block block = null;
   
   public MCreatorGreat_oak_gate_closed(Elementsbyg instance) {
     super(instance, 2133);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:great_oak_gate_closed", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("great_oak_gate_closed");
       setUnlocalizedName("great_oak_gate_closed");
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(MCreatorGreat_oak_gate.block, 1);
     }
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorGreat_oak_gate.block, 1));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorGreatoakgateclosedOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorGreat_oak_gate_closed.class
