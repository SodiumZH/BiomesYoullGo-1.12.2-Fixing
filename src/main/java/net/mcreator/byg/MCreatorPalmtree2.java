 ...
 public class MCreatorPalmtree2 extends Elementsbyg.ModElement {
   public MCreatorPalmtree2(Elementsbyg instance) {
     super(instance, 1402);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 80000) {
       ...
       IBlockState require = MCreatorLight_blue_sand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = MCreatorPink_sand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = MCreatorPurple_sand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = MCreatorWhitesand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = MCreatorBlacksand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:btropical_islands")))
         biomeCriteria = true; 
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("beaches")))
         biomeCriteria = true; 
       if (!biomeCriteria)
         return; 
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "palmtree2"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPalmtree2.class
