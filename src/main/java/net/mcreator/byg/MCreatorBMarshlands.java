 ...
 public class MCreatorBMarshlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bmarshlands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBMarshlands(Elementsbyg instance) {
     super(instance, 1623);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.WET, BiomeDictionary.Type.LUSH });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Marshlands")).setRainfall(0.7F).setBaseHeight(-0.35F).setWaterColor(-12210702).setHeightVariation(0.0F)
           .setTemperature(0.8F));
       setRegistryName("bmarshlands");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBMarshlands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBMarshlands.class
