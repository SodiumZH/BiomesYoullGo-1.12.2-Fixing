 ...
 public class MCreatorDsrock11 extends Elementsbyg.ModElement {
   public MCreatorDsrock11(Elementsbyg instance) {
     super(instance, 1405);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "ds_rock3"));
       ...
       }  BlockPos spawnTo = new BlockPos(i, j + -20, k);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorDsrock11.class
