 ...
 public class MCreatorMangrove_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:mangrove_gate")
   public static final Block block = null;
   
   public MCreatorMangrove_gate(Elementsbyg instance) {
     super(instance, 2146);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:mangrove_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("mangrove_gate");
       setUnlocalizedName("mangrove_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorMangrovegateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMangrove_gate.class
