 ...
 public class MCreatorRainboweucalyptuslog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rainboweucalyptuslog")
   public static final Block block = null;
   
   public MCreatorRainboweucalyptuslog(Elementsbyg instance) {
     super(instance, 745);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:rainboweucalyptuslog", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("rainboweucalyptuslog");
       setUnlocalizedName("rainboweucalyptuslog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRainboweucalyptuslog.class
