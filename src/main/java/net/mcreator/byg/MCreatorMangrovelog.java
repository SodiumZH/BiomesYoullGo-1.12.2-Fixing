 ...
 public class MCreatorMangrovelog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:mangrovelog")
   public static final Block block = null;
   
   public MCreatorMangrovelog(Elementsbyg instance) {
     super(instance, 20);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:mangrovelog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("mangrovelog");
       setUnlocalizedName("mangrovelog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMangrovelog.class
