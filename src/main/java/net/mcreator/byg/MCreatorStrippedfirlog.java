 ...
 public class MCreatorStrippedfirlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:strippedfirlog")
   public static final Block block = null;
   
   public MCreatorStrippedfirlog(Elementsbyg instance) {
     super(instance, 1180);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:strippedfirlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("strippedfirlog");
       setUnlocalizedName("strippedfirlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStrippedfirlog.class
