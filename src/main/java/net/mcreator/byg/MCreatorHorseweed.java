 ...
 public class MCreatorHorseweed
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:horseweed")
   public static final Block block = null;
   
   public MCreatorHorseweed(Elementsbyg instance) {
     super(instance, 2371);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:horseweed", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("horseweed");
       setRegistryName("horseweed");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorHorseweed.class
