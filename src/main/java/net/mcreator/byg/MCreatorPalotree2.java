 ...
 public class MCreatorPalotree2 extends Elementsbyg.ModElement {
   public MCreatorPalotree2(Elementsbyg instance) {
     super(instance, 364);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 50000) {
       ...
       IBlockState require = Blocks.SAND.getStateFromMeta(1);
       try {
       ...
       require = MCreatorSandygrass.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       if (!blockCriteria)
         return; 
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "palo_verde3"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPalotree2.class
