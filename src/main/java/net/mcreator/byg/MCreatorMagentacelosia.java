 ...
 public class MCreatorMagentacelosia
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:magentacelosia")
   public static final Block block = null;
   
   public MCreatorMagentacelosia(Elementsbyg instance) {
     super(instance, 1195);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:magentacelosia", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("magentacelosia");
       setRegistryName("magentacelosia");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMagentacelosia.class
