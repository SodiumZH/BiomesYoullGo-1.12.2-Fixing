 ...
 public class MCreatorBStellataPasture
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bstellatapasture")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBStellataPasture(Elementsbyg instance) {
     super(instance, 194);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Stellata Pasture")).setRainfall(0.6F).setBaseHeight(0.25F).setWaterColor(-13804098)
           .setHeightVariation(0.15F).setTemperature(0.75F));
       setRegistryName("bstellatapasture");
       this.topBlock = MCreatorPasturegrass.block.getDefaultState();
       this.fillerBlock = MCreatorPasturdirt.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBStellataPasture.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != MCreatorPasturegrass.block.getDefaultState().getBlock() && ground != MCreatorPasturdirt.block.getDefaultState()
           .getBlock()) || (ground2 != MCreatorPasturegrass.block.getDefaultState().getBlock() && ground2 != MCreatorPasturdirt.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), MCreatorPasturdirt.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == MCreatorPasturegrass.block.getDefaultState().getBlock() || blockType == MCreatorPasturdirt.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != MCreatorPasturdirt.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, MCreatorPasturdirt.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBStellataPasture.class
