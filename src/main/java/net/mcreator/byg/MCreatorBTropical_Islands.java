 ...
 public class MCreatorBTropical_Islands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:btropical_islands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBTropical_Islands(Elementsbyg instance) {
     super(instance, 1370);
   }
   ...
   static class BiomeGenCustom extends Biome {
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBTropical_Islands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBTropical_Islands.class
