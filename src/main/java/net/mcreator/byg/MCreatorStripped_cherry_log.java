 ...
 public class MCreatorStripped_cherry_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_cherry_log")
   public static final Block block = null;
   
   public MCreatorStripped_cherry_log(Elementsbyg instance) {
     super(instance, 1505);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_cherry_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setUnlocalizedName("stripped_cherry_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_cherry_log.class
