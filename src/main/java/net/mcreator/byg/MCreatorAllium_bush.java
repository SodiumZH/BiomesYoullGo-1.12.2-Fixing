 ...
 public class MCreatorAllium_bush
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:allium_bush")
   public static final Block block = null;
   
   public MCreatorAllium_bush(Elementsbyg instance) {
     super(instance, 1285);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:allium_bush", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("allium_bush");
       setRegistryName("allium_bush");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAllium_bush.class
