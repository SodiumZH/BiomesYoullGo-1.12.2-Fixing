 ...
 public class MCreatorPink_smooth_sandstone
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:pink_smooth_sandstone")
   public static final Block block = null;
   
   public MCreatorPink_smooth_sandstone(Elementsbyg instance) {
     super(instance, 1366);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPink_smooth_sandstone.class
