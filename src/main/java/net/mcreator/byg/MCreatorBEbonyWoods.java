 ...
 public class MCreatorBEbonyWoods
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bebonywoods")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBEbonyWoods(Elementsbyg instance) {
     super(instance, 1061);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.DENSE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Ebony Woods")).setRainfall(0.5F).setBaseHeight(0.6F).setWaterColor(-14329397).setHeightVariation(0.1F)
           .setTemperature(0.7F));
       setRegistryName("bebonywoods");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBEbonyWoods.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBEbonyWoods.class
