 ...
 public class MCreatorGreenenchantedlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:greenenchantedlog")
   public static final Block block = null;
   
   public MCreatorGreenenchantedlog(Elementsbyg instance) {
     super(instance, 1199);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:greenenchantedlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("greenenchantedlog");
       setUnlocalizedName("greenenchantedlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorGreenenchantedlog.class
