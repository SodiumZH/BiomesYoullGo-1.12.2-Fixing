 ...
 public class MCreatorSnowdrops
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:snowdrops")
   public static final Block block = null;
   
   public MCreatorSnowdrops(Elementsbyg instance) {
     super(instance, 837);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:snowdrops", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("snowdrops");
       setRegistryName("snowdrops");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSnowdrops.class
