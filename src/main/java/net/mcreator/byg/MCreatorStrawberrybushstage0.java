 ...
 public class MCreatorStrawberrybushstage0 extends Elementsbyg.ModElement {
   @ObjectHolder("byg:strawberrybushstage0")
   public static final Block block = null;
   
   public MCreatorStrawberrybushstage0(Elementsbyg instance) {
     super(instance, 868);
   }
   ...
   public static class BlockCustomFlower
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == MCreatorStrawberrybushstage0.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorStrawberrybushstage0UpdateTick.executeProcedure($_dependencies);
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorStrawberrybushstage0OnBlockRightclicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStrawberrybushstage0.class
