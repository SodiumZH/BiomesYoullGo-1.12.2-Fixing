 ...
 public class MCreatorRedwood_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:redwood_gate")
   public static final Block block = null;
   
   public MCreatorRedwood_gate(Elementsbyg instance) {
     super(instance, 2158);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorRedwoodgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRedwood_gate.class
