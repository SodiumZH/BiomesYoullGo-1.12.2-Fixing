 ...
 public class MCreatorBSnowyDeciduousForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bsnowydeciduousforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSnowyDeciduousForest(Elementsbyg instance) {
     super(instance, 2309);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SNOWY });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Snowy Deciduous Forest")).setRainfall(0.5F).setBaseHeight(0.25F).setWaterColor(-14329397)
           .setHeightVariation(0.05F).setTemperature(-0.5F));
       setRegistryName("bsnowydeciduousforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSnowyDeciduousForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSnowyDeciduousForest.class
