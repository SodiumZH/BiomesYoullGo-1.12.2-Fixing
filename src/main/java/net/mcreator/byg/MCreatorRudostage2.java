 ...
 public class MCreatorRudostage2 extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rudostage2")
   public static final Block block = null;
   
   public MCreatorRudostage2(Elementsbyg instance) {
     super(instance, 854);
   }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == MCreatorRudostage2.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorRudostage2UpdateTick.executeProcedure($_dependencies);
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorRudostage2OnBlockRightclicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRudostage2.class
