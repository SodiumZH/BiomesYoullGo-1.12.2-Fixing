 ...
 public class MCreatorBGlaciers
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bglaciers")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBGlaciers(Elementsbyg instance) {
     super(instance, 208);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HILLS });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Glaciers")).setRainfall(0.8F).setBaseHeight(2.0F).setWaterColor(-5309697)
           .setHeightVariation(0.02F).setTemperature(-0.5F));
       setRegistryName("bglaciers");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBGlaciers.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Blocks.PACKED_ICE.getDefaultState().getBlock() && ground != Blocks.ICE.getDefaultState().getBlock()) || (ground2 != Blocks.PACKED_ICE
           .getDefaultState().getBlock() && ground2 != Blocks.ICE.getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Blocks.ICE.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Blocks.PACKED_ICE.getDefaultState().getBlock() || blockType == Blocks.ICE
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Blocks.ICE.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Blocks.ICE.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBGlaciers.class
