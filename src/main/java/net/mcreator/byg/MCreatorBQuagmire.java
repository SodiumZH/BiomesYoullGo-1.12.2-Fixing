 ...
 public class MCreatorBQuagmire
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bquagmire")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBQuagmire(Elementsbyg instance) {
     super(instance, 211);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.WASTELAND, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.WET });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Quagmire")).setRainfall(0.4F).setBaseHeight(-0.35F).setWaterColor(-10675200).setHeightVariation(0.0F)
           .setTemperature(0.8F));
       setRegistryName("bquagmire");
       this.topBlock = MCreatorMudblock.block.getDefaultState();
       this.fillerBlock = MCreatorMudblock.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBQuagmire.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != MCreatorMudblock.block.getDefaultState().getBlock() && ground != MCreatorMudblock.block.getDefaultState()
           .getBlock()) || (ground2 != MCreatorMudblock.block.getDefaultState().getBlock() && ground2 != MCreatorMudblock.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), MCreatorMudblock.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == MCreatorMudblock.block.getDefaultState().getBlock() || blockType == MCreatorMudblock.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != MCreatorMudblock.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, MCreatorMudblock.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBQuagmire.class
