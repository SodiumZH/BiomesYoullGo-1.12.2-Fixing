 ...
 public class MCreatorBWeepingWitchForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bweepingwitchforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBWeepingWitchForest(Elementsbyg instance) {
     super(instance, 824);
   }
   ...
   static class BiomeGenCustom extends Biome {
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBWeepingWitchForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBWeepingWitchForest.class
