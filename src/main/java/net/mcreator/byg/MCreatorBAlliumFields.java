 ...
 public class MCreatorBAlliumFields
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:balliumfields")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBAlliumFields(Elementsbyg instance) {
     super(instance, 210);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Allium Fields")).setRainfall(0.6F).setBaseHeight(0.25F).setHeightVariation(0.15F).setTemperature(0.8F));
       setRegistryName("balliumfields");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBAlliumFields.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
         ...
         if (position.getY() < world.getHeight() - height - 1) {
               ...
               for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; i2++) {
                 ...
                 if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || (rand.nextInt(2) != 0 && i4 != 0)) {
                   ...
                   if (state.getBlock().isAir(state, (IBlockAccess)world, blockpos) || state.getBlock().isLeaves(state, (IBlockAccess)world, blockpos) || state
                     ...
                     .getBlock() == MCreatorJacarandaleaves.block.getDefaultState().getBlock()) {
                     setBlockAndNotifyAdequately(world, blockpos, MCreatorJacarandaleaves.block.getDefaultState());
                   }
                 } 
               } 
             } 
           ...
           for (genh = 0; genh < height; genh++) {
             ...
             if (state.getBlock().isAir(state, (IBlockAccess)world, genhPos) || state.getBlock() == Blocks.AIR.getDefaultState().getBlock() || state
               .getBlock() == MCreatorJacarandaleaves.block.getDefaultState().getBlock()) {
               setBlockAndNotifyAdequately(world, position.up(genh), MCreatorJacarandalog.block.getDefaultState());
             }
           } 
               ...
               for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                 if (rand.nextInt(4 - hlevel) == 0) {
                   ...
                   setBlockAndNotifyAdequately(world, position
                       .add(enumfacing1.getFrontOffsetX(), height - 5 + hlevel, enumfacing1.getFrontOffsetZ()), MCreatorJacarandalog.block
                       .getDefaultState());
                 } 
               } 
             } 
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == MCreatorJacarandalog.block.getDefaultState().getBlock() || blockType == MCreatorJacarandaleaves.block
         .getDefaultState().getBlock() || blockType == Blocks.GRASS
         .getDefaultState().getBlock() || blockType == Blocks.DIRT.getStateFromMeta(0).getBlock());
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBAlliumFields.class
