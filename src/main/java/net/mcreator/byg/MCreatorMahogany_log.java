 ...
 public class MCreatorMahogany_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:mahogany_log")
   public static final Block block = null;
   
   public MCreatorMahogany_log(Elementsbyg instance) {
     super(instance, 1389);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:mahogany_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setUnlocalizedName("mahogany_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMahogany_log.class
