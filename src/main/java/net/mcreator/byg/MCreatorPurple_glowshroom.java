 ...
 public class MCreatorPurple_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:purple_glowshroom")
   public static final Block block = null;
   
   public MCreatorPurple_glowshroom(Elementsbyg instance) {
     super(instance, 1314);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorPurpleglowshroomitem.block, 4));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPurple_glowshroom.class
