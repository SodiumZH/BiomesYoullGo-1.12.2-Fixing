 ...
 public class MCreatorBCypress_Swamplands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bcypress_swamplands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBCypress_Swamplands(Elementsbyg instance) {
     super(instance, 1371);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.WET, BiomeDictionary.Type.DENSE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Cypress Swamplands")).setRainfall(0.7F).setBaseHeight(-0.45F).setWaterColor(-12210702)
           .setHeightVariation(0.0F).setTemperature(0.8F));
       setRegistryName("bcypress_swamplands");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBCypress_Swamplands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBCypress_Swamplands.class
