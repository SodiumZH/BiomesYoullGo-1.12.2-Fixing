 ...
 public class MCreatorStripped_rowan_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_rowan_log")
   public static final Block block = null;
   
   public MCreatorStripped_rowan_log(Elementsbyg instance) {
     super(instance, 1557);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_rowan_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_rowan_log");
       setUnlocalizedName("stripped_rowan_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_rowan_log.class
