 ...
 public class MCreatorStructure_spawn_block
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:structure_spawn_block")
   public static final Block block = null;
   
   public MCreatorStructure_spawn_block(Elementsbyg instance) {
     super(instance, 2396);
   }
   ...
   public static class BlockCustom
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorStructurespawnblockUpdateTick.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStructure_spawn_block.class
