 ...
 public class MCreatorBOrchard
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:borchard")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBOrchard(Elementsbyg instance) {
     super(instance, 195);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.FOREST });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Orchard")).setRainfall(0.6F).setBaseHeight(0.3F).setWaterColor(-12618012).setHeightVariation(0.15F)
           .setTemperature(0.8F));
       setRegistryName("borchard");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBOrchard.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBOrchard.class
