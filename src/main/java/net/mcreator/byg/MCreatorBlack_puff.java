 ...
 public class MCreatorBlack_puff extends Elementsbyg.ModElement {
   @ObjectHolder("byg:black_puff")
   public static final Block block = null;
   
   public MCreatorBlack_puff(Elementsbyg instance) {
     super(instance, 2366);
   }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == MCreatorBlack_puff.block);
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlack_puff.class
