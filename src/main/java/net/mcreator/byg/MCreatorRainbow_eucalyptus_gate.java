 ...
 public class MCreatorRainbow_eucalyptus_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rainbow_eucalyptus_gate")
   public static final Block block = null;
   
   public MCreatorRainbow_eucalyptus_gate(Elementsbyg instance) {
     super(instance, 2156);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:rainbow_eucalyptus_gate", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("rainbow_eucalyptus_gate");
       setUnlocalizedName("rainbow_eucalyptus_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorRainboweucalyptusgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRainbow_eucalyptus_gate.class
