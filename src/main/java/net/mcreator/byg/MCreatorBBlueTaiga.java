 ...
 public class MCreatorBBlueTaiga
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bbluetaiga")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBBlueTaiga(Elementsbyg instance) {
     super(instance, 184);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Blue Taiga")).setRainfall(0.5F).setBaseHeight(0.8F).setWaterColor(-12618012).setHeightVariation(0.15F)
           .setTemperature(0.25F));
       setRegistryName("bbluetaiga");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBBlueTaiga.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBBlueTaiga.class
