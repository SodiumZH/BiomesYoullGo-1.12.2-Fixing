 ...
 public class MCreatorStripped_cika_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_cika_log")
   public static final Block block = null;
   
   public MCreatorStripped_cika_log(Elementsbyg instance) {
     super(instance, 1502);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_cika_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_cika_log");
       setUnlocalizedName("stripped_cika_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_cika_log.class
