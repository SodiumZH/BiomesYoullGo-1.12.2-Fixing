 ...
 public class MCreatorStripped_redwood_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_redwood_log")
   public static final Block block = null;
   
   public MCreatorStripped_redwood_log(Elementsbyg instance) {
     super(instance, 1545);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_redwood_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_redwood_log");
       setUnlocalizedName("stripped_redwood_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_redwood_log.class
