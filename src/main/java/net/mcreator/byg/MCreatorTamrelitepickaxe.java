 ...
 public class MCreatorTamrelitepickaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:tamrelitepickaxe")
   public static final Item block = null;
   
   public MCreatorTamrelitepickaxe(Elementsbyg instance) {
     super(instance, 485);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemPickaxe(EnumHelper.addToolMaterial("TAMRELITEPICKAXE", 4, 750, 5.0F, 1.0F, 8)) {
         ...
         }).setUnlocalizedName("tamrelitepickaxe").setRegistryName("tamrelitepickaxe")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorTamrelitepickaxe.class
