 ...
 public class MCreatorStripped_jacaranda_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_jacaranda_log")
   public static final Block block = null;
   
   public MCreatorStripped_jacaranda_log(Elementsbyg instance) {
     super(instance, 1520);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_jacaranda_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_jacaranda_log");
       setUnlocalizedName("stripped_jacaranda_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_jacaranda_log.class
