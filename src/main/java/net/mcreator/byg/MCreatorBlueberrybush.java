 ...
 public class MCreatorBlueberrybush
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:blueberrybush")
   public static final Block block = null;
   
   public MCreatorBlueberrybush(Elementsbyg instance) {
     super(instance, 118);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:blueberrybush", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorBlueberrybushOnBlockRightclicked.executeProcedure($_dependencies);
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorBlueberry.block, 2));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlueberrybush.class
