 ...
 public class MCreatorAllium_bush2
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:allium_bush2")
   public static final Block block = null;
   
   public MCreatorAllium_bush2(Elementsbyg instance) {
     super(instance, 1286);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:allium_bush2", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("allium_bush2");
       setRegistryName("allium_bush2");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAllium_bush2.class
