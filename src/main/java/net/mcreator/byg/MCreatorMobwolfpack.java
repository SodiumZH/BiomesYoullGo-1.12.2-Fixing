 ...
 public class MCreatorMobwolfpack extends Elementsbyg.ModElement {
   public MCreatorMobwolfpack(Elementsbyg instance) {
     super(instance, 1463);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 50000) {
       ...
       IBlockState require = Blocks.GRASS.getDefaultState();
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bseasonalbirchforest")))
         biomeCriteria = true; 
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bwhisperingwoods")))
         biomeCriteria = true; 
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bdovermoutains")))
         biomeCriteria = true; 
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bgiant_blue_spruce_taiga")))
         biomeCriteria = true; 
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bgiant_seasonal_spruce_taiga")))
         biomeCriteria = true; 
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "mob_wolfpack"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMobwolfpack.class
