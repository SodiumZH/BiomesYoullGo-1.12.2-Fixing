 ...
 public class MCreatorBAspenForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:baspenforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBAspenForest(Elementsbyg instance) {
     super(instance, 1441);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Aspen Forest")).setRainfall(0.5F).setBaseHeight(0.55F).setWaterColor(-14329397).setHeightVariation(0.15F)
           .setTemperature(0.5F));
       setRegistryName("baspenforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBAspenForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBAspenForest.class
