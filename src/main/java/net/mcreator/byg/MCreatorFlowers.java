 ...
 public class MCreatorFlowers extends Elementsbyg.ModElement {
   @ObjectHolder("byg:flowers")
   public static final Block block = null;
   
   public MCreatorFlowers(Elementsbyg instance) {
     super(instance, 2355);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:flowers", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFlowers.class
