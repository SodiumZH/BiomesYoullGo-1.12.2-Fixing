 ...
 public class MCreatorSkyrislog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:skyrislog")
   public static final Block block = null;
   
   public MCreatorSkyrislog(Elementsbyg instance) {
     super(instance, 44);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:skyrislog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("skyrislog");
       setUnlocalizedName("skyrislog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSkyrislog.class
