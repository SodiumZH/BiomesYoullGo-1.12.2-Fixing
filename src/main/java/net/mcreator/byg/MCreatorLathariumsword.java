 ...
 public class MCreatorLathariumsword
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:lathariumsword")
   public static final Item block = null;
   
   public MCreatorLathariumsword(Elementsbyg instance) {
     super(instance, 933);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemSword(EnumHelper.addToolMaterial("LATHARIUMSWORD", 1, 950, 4.0F, 3.0F, 8)) {
         ...
         }).setUnlocalizedName("lathariumsword").setRegistryName("lathariumsword")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorLathariumsword.class
