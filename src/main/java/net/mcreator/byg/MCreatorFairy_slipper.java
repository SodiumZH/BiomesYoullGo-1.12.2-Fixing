 ...
 public class MCreatorFairy_slipper
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:fairy_slipper")
   public static final Block block = null;
   
   public MCreatorFairy_slipper(Elementsbyg instance) {
     super(instance, 2347);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:fairy_slipper", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.8F);
       setUnlocalizedName("fairy_slipper");
       setRegistryName("fairy_slipper");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFairy_slipper.class
