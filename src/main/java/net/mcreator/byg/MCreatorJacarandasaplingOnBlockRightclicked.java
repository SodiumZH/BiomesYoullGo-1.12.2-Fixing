 ...
 public class MCreatorJacarandasaplingOnBlockRightclicked
   extends Elementsbyg.ModElement {
   public MCreatorJacarandasaplingOnBlockRightclicked(Elementsbyg instance) {
     super(instance, 566);
   }
   
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     if (dependencies.get("entity") == null) {
       System.err.println("Failed to load dependency entity for procedure MCreatorJacarandasaplingOnBlockRightclicked!");
       return;
     } 
     if (dependencies.get("x") == null) {
       System.err.println("Failed to load dependency x for procedure MCreatorJacarandasaplingOnBlockRightclicked!");
       return;
     } 
     if (dependencies.get("y") == null) {
       System.err.println("Failed to load dependency y for procedure MCreatorJacarandasaplingOnBlockRightclicked!");
       return;
     } 
     if (dependencies.get("z") == null) {
       System.err.println("Failed to load dependency z for procedure MCreatorJacarandasaplingOnBlockRightclicked!");
       return;
     } 
     if (dependencies.get("world") == null) {
       System.err.println("Failed to load dependency world for procedure MCreatorJacarandasaplingOnBlockRightclicked!");
       return;
     } 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorJacarandasaplingOnBlockRightclicked.class
