 ...
 public class MCreatorPendoritehoe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pendoritehoe")
   public static final Item block = null;
   
   public MCreatorPendoritehoe(Elementsbyg instance) {
     super(instance, 521);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemHoe(EnumHelper.addToolMaterial("PENDORITEHOE", 1, 1200, 4.0F, 5.0F, 2)) {
         ...
         }).setUnlocalizedName("pendoritehoe").setRegistryName("pendoritehoe")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPendoritehoe.class
