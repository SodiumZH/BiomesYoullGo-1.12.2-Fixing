 ...
 public class MCreatorAngelica
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:angelica")
   public static final Block block = null;
   
   public MCreatorAngelica(Elementsbyg instance) {
     super(instance, 2341);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:angelica", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("angelica");
       setRegistryName("angelica");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAngelica.class
