 ...
 public class MCreatorDeadgrass extends Elementsbyg.ModElement {
   @ObjectHolder("byg:deadgrass")
   public static final Block block = null;
   
   public MCreatorDeadgrass(Elementsbyg instance) {
     super(instance, 96);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:deadgrass", "inventory"));
   }
           ...
           public boolean generate(World world, Random random, BlockPos pos) {
             for (int i = 0; i < 20; i++) {
               ...
               if (world.isAirBlock(blockpos1)) {
                 ...
                 j = Math.min(1, j);
                 for (int k = 0; k < j; k++) {
                   if (((BlockReed)MCreatorDeadgrass.block).canBlockStay(world, blockpos1))
                     world.setBlockState(blockpos1.up(k), MCreatorDeadgrass.block.getDefaultState(), 2); 
                 } 
               } 
             }  return true;
           }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == MCreatorDeadgrass.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       if ((world.getBlockState(pos.down()).getBlock() == MCreatorDeadgrass.block || checkForDrop(world, pos, state)) && 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorDeadgrass.class
