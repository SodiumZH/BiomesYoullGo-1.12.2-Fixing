 ...
 public class MCreatorDelphinium
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:delphinium")
   public static final Block block = null;
   
   public MCreatorDelphinium(Elementsbyg instance) {
     super(instance, 2348);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:delphinium", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("delphinium");
       setRegistryName("delphinium");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorDelphinium.class
