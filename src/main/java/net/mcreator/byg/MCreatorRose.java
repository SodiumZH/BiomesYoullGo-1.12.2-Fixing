 ...
 public class MCreatorRose
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:rose")
   public static final Block block = null;
   
   public MCreatorRose(Elementsbyg instance) {
     super(instance, 87);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:rose", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRose.class
