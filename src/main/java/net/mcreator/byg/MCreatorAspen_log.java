 ...
 public class MCreatorAspen_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:aspen_log")
   public static final Block block = null;
   
   public MCreatorAspen_log(Elementsbyg instance) {
     super(instance, 1431);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:aspen_log", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAspen_log.class
