 ...
 public class MCreatorLollipop_flower
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:lollipop_flower")
   public static final Block block = null;
   
   public MCreatorLollipop_flower(Elementsbyg instance) {
     super(instance, 2353);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:lollipop_flower", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("lollipop_flower");
       setRegistryName("lollipop_flower");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorLollipop_flower.class
