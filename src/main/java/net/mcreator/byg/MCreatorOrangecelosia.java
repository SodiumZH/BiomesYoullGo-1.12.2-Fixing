 ...
 public class MCreatorOrangecelosia
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:orangecelosia")
   public static final Block block = null;
   
   public MCreatorOrangecelosia(Elementsbyg instance) {
     super(instance, 1197);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:orangecelosia", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("orangecelosia");
       setRegistryName("orangecelosia");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorOrangecelosia.class
