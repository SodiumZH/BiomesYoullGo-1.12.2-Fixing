 ...
 public class MCreatorBGreatOakLowlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bgreatoaklowlands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBGreatOakLowlands(Elementsbyg instance) {
     super(instance, 181);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SPARSE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Great Oak Lowlands")).setRainfall(0.5F).setBaseHeight(0.03F).setWaterColor(-12618012)
           .setHeightVariation(0.01F).setTemperature(0.7F));
       setRegistryName("bgreatoaklowlands");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBGreatOakLowlands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBGreatOakLowlands.class
