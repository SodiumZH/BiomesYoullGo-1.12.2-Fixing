 ...
 public class MCreatorStripped_hawthorn_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_hawthorn_log")
   public static final Block block = null;
   
   public MCreatorStripped_hawthorn_log(Elementsbyg instance) {
     super(instance, 1560);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_hawthorn_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_hawthorn_log");
       setUnlocalizedName("stripped_hawthorn_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_hawthorn_log.class
