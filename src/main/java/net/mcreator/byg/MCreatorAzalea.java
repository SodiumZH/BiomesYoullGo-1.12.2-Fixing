 ...
 public class MCreatorAzalea
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:azalea")
   public static final Block block = null;
   
   public MCreatorAzalea(Elementsbyg instance) {
     super(instance, 2342);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:azalea", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAzalea.class
