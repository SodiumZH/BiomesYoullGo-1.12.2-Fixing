 ...
 public class MCreatorBayoutree1 extends Elementsbyg.ModElement {
   public MCreatorBayoutree1(Elementsbyg instance) {
     super(instance, 341);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 990000) {
       ...
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = Blocks.WATER.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       if (!blockCriteria)
         return; 
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "bayoutree1"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBayoutree1.class
