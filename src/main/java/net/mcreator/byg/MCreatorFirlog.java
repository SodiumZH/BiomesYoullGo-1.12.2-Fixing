 ...
 public class MCreatorFirlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:firlog")
   public static final Block block = null;
   
   public MCreatorFirlog(Elementsbyg instance) {
     super(instance, 1175);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:firlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("firlog");
       setUnlocalizedName("firlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFirlog.class
