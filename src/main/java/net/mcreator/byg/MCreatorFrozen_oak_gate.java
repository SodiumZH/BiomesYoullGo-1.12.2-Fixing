 ...
 public class MCreatorFrozen_oak_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:frozen_oak_gate")
   public static final Block block = null;
   
   public MCreatorFrozen_oak_gate(Elementsbyg instance) {
     super(instance, 2150);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:frozen_oak_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("frozen_oak_gate");
       setUnlocalizedName("frozen_oak_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorFrozenoakgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFrozen_oak_gate.class
