 ...
 public class MCreatorStripped_green_enchanted_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_green_enchanted_log")
   public static final Block block = null;
   
   public MCreatorStripped_green_enchanted_log(Elementsbyg instance) {
     super(instance, 1514);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_green_enchanted_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_green_enchanted_log");
       setUnlocalizedName("stripped_green_enchanted_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_green_enchanted_log.class
