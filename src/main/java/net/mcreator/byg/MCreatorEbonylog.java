 ...
 public class MCreatorEbonylog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:ebonylog")
   public static final Block block = null;
   
   public MCreatorEbonylog(Elementsbyg instance) {
     super(instance, 988);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:ebonylog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("ebonylog");
       setUnlocalizedName("ebonylog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorEbonylog.class
