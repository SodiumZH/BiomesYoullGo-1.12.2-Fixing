 ...
 public class MCreatorLeafpile extends Elementsbyg.ModElement {
   @ObjectHolder("byg:leafpile")
   public static final Block block = null;
   
   public MCreatorLeafpile(Elementsbyg instance) {
     super(instance, 94);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:leafpile", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setRegistryName("leafpile");
       setUnlocalizedName("leafpile");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorLeafpile.class
