 ...
 public class MCreatorSmall_blue_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:small_blue_glowshroom")
   public static final Block block = null;
   
   public MCreatorSmall_blue_glowshroom(Elementsbyg instance) {
     super(instance, 1320);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:small_blue_glowshroom", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       ...
       setRegistryName("small_blue_glowshroom");
       setUnlocalizedName("small_blue_glowshroom");
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorBlueglowshroomitem.block, 2));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorSmallblueglowshroomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSmall_blue_glowshroom.class
