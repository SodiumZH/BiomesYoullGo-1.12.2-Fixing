 ...
 public class MCreatorBluesage
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:bluesage")
   public static final Block block = null;
   
   public MCreatorBluesage(Elementsbyg instance) {
     super(instance, 1116);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:bluesage", "inventory"));
   }
   ...
   public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:beucalyptustropics")))
       biomeCriteria = true; 
     if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bebonywoods")))
       biomeCriteria = true; 
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("bluesage");
       setRegistryName("bluesage");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBluesage.class
