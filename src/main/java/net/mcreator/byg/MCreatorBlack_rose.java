 ...
 public class MCreatorBlack_rose
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:black_rose")
   public static final Block block = null;
   
   public MCreatorBlack_rose(Elementsbyg instance) {
     super(instance, 2346);
   }
 
   
   public void init(FMLInitializationEvent event) {
     OreDictionary.registerOre("flowerBlack", block);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:black_rose", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("black_rose");
       setRegistryName("black_rose");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlack_rose.class
