 ...
 public class MCreatorCherrylog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:cherrylog")
   public static final Block block = null;
   
   public MCreatorCherrylog(Elementsbyg instance) {
     super(instance, 3);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:cherrylog", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCherrylog.class
