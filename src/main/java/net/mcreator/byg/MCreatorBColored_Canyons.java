 ...
 public class MCreatorBColored_Canyons
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bcolored_canyons")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBColored_Canyons(Elementsbyg instance) {
     super(instance, 2398);
   }
   ...
   static class BiomeGenCustom extends Biome {
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBColored_Canyons.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != MCreatorRed_cracked_sand.block.getDefaultState().getBlock() && ground != Blocks.RED_SANDSTONE
           .getStateFromMeta(0).getBlock()) || (ground2 != MCreatorRed_cracked_sand.block.getDefaultState().getBlock() && ground2 != Blocks.RED_SANDSTONE
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBColored_Canyons.class
