 ...
 public class MCreatorBorealPodzolPatch2 extends Elementsbyg.ModElement {
   public MCreatorBorealPodzolPatch2(Elementsbyg instance) {
     super(instance, 222);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 0) {
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "boreal_podzolpatch2"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBorealPodzolPatch2.class
