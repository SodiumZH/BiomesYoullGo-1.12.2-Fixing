 ...
 public class MCreatorBSeasonalTaiga
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bseasonaltaiga")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSeasonalTaiga(Elementsbyg instance) {
     super(instance, 189);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.COLD, BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.FOREST });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Seasonal Taiga")).setRainfall(0.5F).setBaseHeight(0.7F).setWaterColor(-12618012)
           .setHeightVariation(0.15F).setTemperature(0.25F));
       setRegistryName("bseasonaltaiga");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSeasonalTaiga.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSeasonalTaiga.class
