 ...
 public class MCreatorEnchantedlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:enchantedlog")
   public static final Block block = null;
   
   public MCreatorEnchantedlog(Elementsbyg instance) {
     super(instance, 11);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:enchantedlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("enchantedlog");
       setUnlocalizedName("enchantedlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorEnchantedlog.class
