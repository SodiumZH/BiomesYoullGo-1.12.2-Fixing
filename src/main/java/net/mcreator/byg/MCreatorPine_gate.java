 ...
 public class MCreatorPine_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:pine_gate")
   public static final Block block = null;
   
   public MCreatorPine_gate(Elementsbyg instance) {
     super(instance, 2154);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:pine_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("pine_gate");
       setUnlocalizedName("pine_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorPinegateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPine_gate.class
