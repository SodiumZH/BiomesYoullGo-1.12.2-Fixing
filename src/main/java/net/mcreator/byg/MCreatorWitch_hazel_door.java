 ...
 public class MCreatorWitch_hazel_door
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:witch_hazel_door")
   public static final Item block = null;
   
   public MCreatorWitch_hazel_door(Elementsbyg instance) {
     super(instance, 1812);
   }
   ...
   public static class ItemCustom extends Item {
     ...
     public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ, EnumHand hand) {
       ...
       MCreatorWitchhazeldoorRightClickedOnBlock.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWitch_hazel_door.class
