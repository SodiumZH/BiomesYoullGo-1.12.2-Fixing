 ...
 public class MCreatorCyanrose
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:cyanrose")
   public static final Block block = null;
   
   public MCreatorCyanrose(Elementsbyg instance) {
     super(instance, 86);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:cyanrose", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("cyanrose");
       setRegistryName("cyanrose");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCyanrose.class
