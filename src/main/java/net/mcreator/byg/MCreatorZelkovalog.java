 ...
 public class MCreatorZelkovalog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:zelkovalog")
   public static final Block block = null;
   
   public MCreatorZelkovalog(Elementsbyg instance) {
     super(instance, 59);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:zelkovalog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("zelkovalog");
       setUnlocalizedName("zelkovalog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorZelkovalog.class
