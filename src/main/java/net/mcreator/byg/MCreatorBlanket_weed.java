 ...
 public class MCreatorBlanket_weed extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blanket_weed")
   public static final Block block = null;
   
   public MCreatorBlanket_weed(Elementsbyg instance) {
     super(instance, 1316);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlanket_weed.class
