 ...
 public class MCreatorAlpine_bellflower
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:alpine_bellflower")
   public static final Block block = null;
   
   public MCreatorAlpine_bellflower(Elementsbyg instance) {
     super(instance, 2340);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:alpine_bellflower", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("alpine_bellflower");
       setRegistryName("alpine_bellflower");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAlpine_bellflower.class
