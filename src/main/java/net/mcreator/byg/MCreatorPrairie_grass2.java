 ...
 public class MCreatorPrairie_grass2
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:prairie_grass2")
   public static final Block block = null;
   
   public MCreatorPrairie_grass2(Elementsbyg instance) {
     super(instance, 1294);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:prairie_grass2", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("prairie_grass2");
       setRegistryName("prairie_grass2");
     }
 
     
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(MCreatorPrairie_grass.block, 1);
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPrairie_grass2.class
