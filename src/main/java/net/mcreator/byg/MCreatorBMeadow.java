 ...
 public class MCreatorBMeadow
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bmeadow")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBMeadow(Elementsbyg instance) {
     super(instance, 201);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Meadow")).setRainfall(0.7F).setBaseHeight(0.25F).setWaterColor(-12618012).setHeightVariation(0.12F)
           .setTemperature(0.8F));
       setRegistryName("bmeadow");
       this.topBlock = MCreatorMeadowgrass.block.getDefaultState();
       this.fillerBlock = MCreatorMeadowdirt.block.getDefaultState();
       ...
       this.decorator.sandPatchesPerChunk = 25;
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBMeadow.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != MCreatorMeadowgrass.block.getDefaultState().getBlock() && ground != MCreatorMeadowdirt.block.getDefaultState()
           .getBlock()) || (ground2 != MCreatorMeadowgrass.block.getDefaultState().getBlock() && ground2 != MCreatorMeadowdirt.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), MCreatorMeadowdirt.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == MCreatorMeadowgrass.block.getDefaultState().getBlock() || blockType == MCreatorMeadowdirt.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != MCreatorMeadowdirt.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, MCreatorMeadowdirt.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBMeadow.class
