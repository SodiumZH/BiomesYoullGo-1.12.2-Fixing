 ...
 public class MCreatorMedium_green_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:medium_green_glowshroom")
   public static final Block block = null;
   
   public MCreatorMedium_green_glowshroom(Elementsbyg instance) {
     super(instance, 1319);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:medium_green_glowshroom", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       ...
       setRegistryName("medium_green_glowshroom");
       setUnlocalizedName("medium_green_glowshroom");
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorGreenglowshroomitem.block, 3));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorMediumgreenglowshroomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMedium_green_glowshroom.class
