 ...
 public class MCreatorRowanlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rowanlog")
   public static final Block block = null;
   
   public MCreatorRowanlog(Elementsbyg instance) {
     super(instance, 991);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:rowanlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("rowanlog");
       setUnlocalizedName("rowanlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRowanlog.class
