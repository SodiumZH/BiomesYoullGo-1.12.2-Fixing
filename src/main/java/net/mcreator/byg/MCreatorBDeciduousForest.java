 ...
 public class MCreatorBDeciduousForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bdeciduousforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBDeciduousForest(Elementsbyg instance) {
     super(instance, 762);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Deciduous Forest")).setRainfall(0.5F).setBaseHeight(0.25F).setWaterColor(-14329397)
           .setHeightVariation(0.05F).setTemperature(0.7F));
       setRegistryName("bdeciduousforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBDeciduousForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBDeciduousForest.class
