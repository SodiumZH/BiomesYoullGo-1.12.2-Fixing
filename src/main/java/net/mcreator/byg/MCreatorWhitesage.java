 ...
 public class MCreatorWhitesage
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:whitesage")
   public static final Block block = null;
   
   public MCreatorWhitesage(Elementsbyg instance) {
     super(instance, 1118);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:whitesage", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("whitesage");
       setRegistryName("whitesage");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWhitesage.class
