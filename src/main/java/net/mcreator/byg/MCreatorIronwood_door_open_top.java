 ...
 public class MCreatorIronwood_door_open_top
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:ironwood_door_open_top")
   public static final Block block = null;
   
   public MCreatorIronwood_door_open_top(Elementsbyg instance) {
     super(instance, 1894);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:ironwood_door_open_top", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("ironwood_door_open_top");
       setUnlocalizedName("ironwood_door_open_top");
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(MCreatorIronwood_door.block, 1);
     }
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorIronwood_door.block, 1));
     }
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       MCreatorIronwooddooropentopNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorIronwooddooropentopOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorIronwood_door_open_top.class
