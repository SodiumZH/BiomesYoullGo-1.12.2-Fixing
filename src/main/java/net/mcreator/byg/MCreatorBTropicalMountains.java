 ...
 public class MCreatorBTropicalMountains
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:btropicalmountains")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBTropicalMountains(Elementsbyg instance) {
     super(instance, 913);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.HOT, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.WET, BiomeDictionary.Type.JUNGLE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Tropical Mountains")).setRainfall(0.8F).setBaseHeight(6.0F).setWaterColor(-14329397)
           .setHeightVariation(1.0F).setTemperature(0.95F));
       setRegistryName("btropicalmountains");
       this.topBlock = MCreatorOvergrown_stone.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBTropicalMountains.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random par2Random, BlockPos pos) {
       ...
       if (ground != MCreatorOvergrown_stone.block.getDefaultState().getBlock() && ground != Blocks.STONE.getStateFromMeta(0).getBlock() && ground2 != MCreatorOvergrown_stone.block
         .getDefaultState().getBlock() && ground2 != Blocks.STONE.getStateFromMeta(0)
         .getBlock())
         return false; 
     ...
     protected boolean canGrowInto(Block blockType) {
       ...
       return (material == Material.AIR || blockType == MCreatorOvergrown_stone.block.getDefaultState().getBlock() || blockType == Blocks.STONE
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBTropicalMountains.class
