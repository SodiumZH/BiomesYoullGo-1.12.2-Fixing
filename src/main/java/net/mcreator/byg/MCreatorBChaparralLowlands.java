 ...
 public class MCreatorBChaparralLowlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bchaparrallowlands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBChaparralLowlands(Elementsbyg instance) {
     super(instance, 760);
   }
   ...
   static class BiomeGenCustom extends Biome {
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBChaparralLowlands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBChaparralLowlands.class
