 ...
 public class MCreatorSalemvillage extends Elementsbyg.ModElement {
   public MCreatorSalemvillage(Elementsbyg instance) {
     super(instance, 1172);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (!dimensionCriteria)
       return; 
     if (random.nextInt(1000000) + 1 <= 9500) {
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "salem_village"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSalemvillage.class
