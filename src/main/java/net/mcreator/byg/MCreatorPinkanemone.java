 ...
 public class MCreatorPinkanemone
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pinkanemone")
   public static final Block block = null;
   
   public MCreatorPinkanemone(Elementsbyg instance) {
     super(instance, 1115);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:pinkanemone", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("pinkanemone");
       setRegistryName("pinkanemone");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPinkanemone.class
