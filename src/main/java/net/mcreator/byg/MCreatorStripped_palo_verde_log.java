 ...
 public class MCreatorStripped_palo_verde_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_palo_verde_log")
   public static final Block block = null;
   
   public MCreatorStripped_palo_verde_log(Elementsbyg instance) {
     super(instance, 1530);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_palo_verde_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_palo_verde_log");
       setUnlocalizedName("stripped_palo_verde_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_palo_verde_log.class
