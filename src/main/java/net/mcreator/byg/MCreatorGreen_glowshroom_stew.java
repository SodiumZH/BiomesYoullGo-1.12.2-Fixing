 ...
 public class MCreatorGreen_glowshroom_stew
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:green_glowshroom_stew")
   public static final Item block = null;
   
   public MCreatorGreen_glowshroom_stew(Elementsbyg instance) {
     super(instance, 1343);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorGreen_glowshroom_stew.class
