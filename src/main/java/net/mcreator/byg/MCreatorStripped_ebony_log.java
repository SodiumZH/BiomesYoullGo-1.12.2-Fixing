 ...
 public class MCreatorStripped_ebony_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_ebony_log")
   public static final Block block = null;
   
   public MCreatorStripped_ebony_log(Elementsbyg instance) {
     super(instance, 1554);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_ebony_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_ebony_log");
       setUnlocalizedName("stripped_ebony_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_ebony_log.class
