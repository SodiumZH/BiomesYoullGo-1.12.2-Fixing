 ...
 public class MCreatorKovan
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:kovan")
   public static final Block block = null;
   
   public MCreatorKovan(Elementsbyg instance) {
     super(instance, 80);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:kovan", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("kovan");
       setRegistryName("kovan");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorKovan.class
