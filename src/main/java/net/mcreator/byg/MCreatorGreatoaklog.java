 ...
 public class MCreatorGreatoaklog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:greatoaklog")
   public static final Block block = null;
   
   public MCreatorGreatoaklog(Elementsbyg instance) {
     super(instance, 14);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:greatoaklog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("greatoaklog");
       setUnlocalizedName("greatoaklog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorGreatoaklog.class
