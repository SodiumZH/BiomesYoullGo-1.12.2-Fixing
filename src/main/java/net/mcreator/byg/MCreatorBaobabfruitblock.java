 ...
 public class MCreatorBaobabfruitblock
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:baobabfruitblock")
   public static final Block block = null;
   
   public MCreatorBaobabfruitblock(Elementsbyg instance) {
     super(instance, 661);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorBaobabfruit.block, 3));
     }
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       MCreatorBaobabfruitblockNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorBaobabfruitblockOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBaobabfruitblock.class
