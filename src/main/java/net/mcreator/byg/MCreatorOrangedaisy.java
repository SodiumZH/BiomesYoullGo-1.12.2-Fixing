 ...
 public class MCreatorOrangedaisy
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:orangedaisy")
   public static final Block block = null;
   
   public MCreatorOrangedaisy(Elementsbyg instance) {
     super(instance, 81);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:orangedaisy", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("orangedaisy");
       setRegistryName("orangedaisy");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorOrangedaisy.class
