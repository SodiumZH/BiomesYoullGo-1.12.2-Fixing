 ...
 public class MCreatorBSeasonalDeciduous
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bseasonaldeciduous")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSeasonalDeciduous(Elementsbyg instance) {
     super(instance, 759);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.COLD, BiomeDictionary.Type.FOREST });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Seasonal Deciduous")).setRainfall(0.4F).setBaseHeight(0.25F).setWaterColor(-14329397)
           .setHeightVariation(0.05F).setTemperature(0.25F));
       setRegistryName("bseasonaldeciduous");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSeasonalDeciduous.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSeasonalDeciduous.class
