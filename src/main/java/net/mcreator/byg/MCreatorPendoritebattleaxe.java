 ...
 public class MCreatorPendoritebattleaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pendoritebattleaxe")
   public static final Item block = null;
   
   public MCreatorPendoritebattleaxe(Elementsbyg instance) {
     super(instance, 915);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemToolCustom() {
         ...
         }).setUnlocalizedName("pendoritebattleaxe").setRegistryName("pendoritebattleaxe")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPendoritebattleaxe.class
