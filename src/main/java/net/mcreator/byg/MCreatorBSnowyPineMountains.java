 ...
 public class MCreatorBSnowyPineMountains
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bsnowypinemountains")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSnowyPineMountains(Elementsbyg instance) {
     super(instance, 848);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.CONIFEROUS });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Snowy Pine Mountains")).setRainfall(0.7F).setBaseHeight(2.0F).setWaterColor(-14329397)
           .setHeightVariation(0.55F).setTemperature(-0.5F));
       setRegistryName("bsnowypinemountains");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSnowyPineMountains.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSnowyPineMountains.class
