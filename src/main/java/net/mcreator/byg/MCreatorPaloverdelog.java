 ...
 public class MCreatorPaloverdelog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:paloverdelog")
   public static final Block block = null;
   
   public MCreatorPaloverdelog(Elementsbyg instance) {
     super(instance, 38);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:paloverdelog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("paloverdelog");
       setUnlocalizedName("paloverdelog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPaloverdelog.class
