 ...
 public class MCreatorWeeping_milk_cap extends Elementsbyg.ModElement {
   @ObjectHolder("byg:weeping_milk_cap")
   public static final Block block = null;
   
   public MCreatorWeeping_milk_cap(Elementsbyg instance) {
     super(instance, 2367);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:weeping_milk_cap", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockReed {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("weeping_milk_cap");
       setRegistryName("weeping_milk_cap");
     }
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == MCreatorWeeping_milk_cap.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorBlackpuffUpdateTick.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWeeping_milk_cap.class
