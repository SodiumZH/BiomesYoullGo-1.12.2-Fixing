 ...
 public class MCreatorBaobablog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:baobablog")
   public static final Block block = null;
   
   public MCreatorBaobablog(Elementsbyg instance) {
     super(instance, 653);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:baobablog", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBaobablog.class
