 ...
 public class MCreatorPendoriteore
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:pendoriteore")
   public static final Block block = null;
   
   public MCreatorPendoriteore(Elementsbyg instance) {
     super(instance, 514);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorPendoritegem.block, 1));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPendoriteore.class
