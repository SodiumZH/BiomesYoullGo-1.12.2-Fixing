 ...
 public class MCreatorJacaranda_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:jacaranda_gate")
   public static final Block block = null;
   
   public MCreatorJacaranda_gate(Elementsbyg instance) {
     super(instance, 2142);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:jacaranda_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("jacaranda_gate");
       setUnlocalizedName("jacaranda_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorJacarandagateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorJacaranda_gate.class
