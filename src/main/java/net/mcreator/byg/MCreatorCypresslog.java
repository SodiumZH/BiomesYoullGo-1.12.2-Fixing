 ...
 public class MCreatorCypresslog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:cypresslog")
   public static final Block block = null;
   
   public MCreatorCypresslog(Elementsbyg instance) {
     super(instance, 1276);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:cypresslog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("cypresslog");
       setUnlocalizedName("cypresslog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCypresslog.class
