 ...
 public class MCreatorStripped_zelkova_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_zelkova_log")
   public static final Block block = null;
   
   public MCreatorStripped_zelkova_log(Elementsbyg instance) {
     super(instance, 1542);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_zelkova_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_zelkova_log");
       setUnlocalizedName("stripped_zelkova_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_zelkova_log.class
