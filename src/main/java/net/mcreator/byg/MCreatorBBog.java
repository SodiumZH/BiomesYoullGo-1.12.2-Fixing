 ...
 public class MCreatorBBog
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bbog")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBBog(Elementsbyg instance) {
     super(instance, 212);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.WET, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.COLD });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Bog")).setRainfall(0.4F).setBaseHeight(0.02F).setWaterColor(-7317161).setHeightVariation(0.01F)
           .setTemperature(0.2F));
       setRegistryName("bbog");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBBog.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBBog.class
