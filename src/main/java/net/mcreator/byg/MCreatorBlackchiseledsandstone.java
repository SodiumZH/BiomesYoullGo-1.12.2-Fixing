 ...
 public class MCreatorBlackchiseledsandstone
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blackchiseledsandstone")
   public static final Block block = null;
   
   public MCreatorBlackchiseledsandstone(Elementsbyg instance) {
     super(instance, 958);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlackchiseledsandstone.class
