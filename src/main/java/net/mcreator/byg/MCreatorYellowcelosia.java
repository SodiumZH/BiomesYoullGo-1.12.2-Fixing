 ...
 public class MCreatorYellowcelosia
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:yellowcelosia")
   public static final Block block = null;
   
   public MCreatorYellowcelosia(Elementsbyg instance) {
     super(instance, 1196);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:yellowcelosia", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("yellowcelosia");
       setRegistryName("yellowcelosia");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorYellowcelosia.class
