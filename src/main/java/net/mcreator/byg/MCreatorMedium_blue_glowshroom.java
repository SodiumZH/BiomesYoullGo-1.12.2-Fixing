 ...
 public class MCreatorMedium_blue_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:medium_blue_glowshroom")
   public static final Block block = null;
   
   public MCreatorMedium_blue_glowshroom(Elementsbyg instance) {
     super(instance, 1317);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:medium_blue_glowshroom", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       ...
       setRegistryName("medium_blue_glowshroom");
       setUnlocalizedName("medium_blue_glowshroom");
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorBlueglowshroomitem.block, 3));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorMediumblueglowshroomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMedium_blue_glowshroom.class
