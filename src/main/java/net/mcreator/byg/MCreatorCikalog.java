 ...
 public class MCreatorCikalog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:cikalog")
   public static final Block block = null;
   
   public MCreatorCikalog(Elementsbyg instance) {
     super(instance, 6);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:cikalog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("cikalog");
       setUnlocalizedName("cikalog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCikalog.class
