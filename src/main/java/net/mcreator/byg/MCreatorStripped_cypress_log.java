 ...
 public class MCreatorStripped_cypress_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_cypress_log")
   public static final Block block = null;
   
   public MCreatorStripped_cypress_log(Elementsbyg instance) {
     super(instance, 1566);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_cypress_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       ...
       setUnlocalizedName("stripped_cypress_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_cypress_log.class
