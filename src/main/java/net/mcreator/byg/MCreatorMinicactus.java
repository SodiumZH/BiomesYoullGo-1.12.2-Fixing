 ...
 public class MCreatorMinicactus extends Elementsbyg.ModElement {
   @ObjectHolder("byg:minicactus")
   public static final Block block = null;
   
   public MCreatorMinicactus(Elementsbyg instance) {
     super(instance, 505);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:minicactus", "inventory"));
   }
           ...
           public boolean generate(World world, Random random, BlockPos pos) {
             for (int i = 0; i < 20; i++) {
               ...
               if (world.isAirBlock(blockpos1)) {
                 ...
                 j = Math.min(1, j);
                 for (int k = 0; k < j; k++) {
                   if (((BlockReed)MCreatorMinicactus.block).canBlockStay(world, blockpos1))
                     world.setBlockState(blockpos1.up(k), MCreatorMinicactus.block.getDefaultState(), 2); 
                 } 
               } 
             }  return true;
           }
   ...
   public static class BlockCustomFlower extends BlockReed {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("minicactus");
       setRegistryName("minicactus");
     }
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == MCreatorMinicactus.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       if ((world.getBlockState(pos.down()).getBlock() == MCreatorMinicactus.block || checkForDrop(world, pos, state)) && 
     ...
     public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
       ...
       MCreatorMinicactusMobplayerColidesBlock.executeProcedure($_dependencies);
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorMinicactus.class
