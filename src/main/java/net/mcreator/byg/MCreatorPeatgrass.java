 ...
 public class MCreatorPeatgrass
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:peatgrass")
   public static final Block block = null;
   
   public MCreatorPeatgrass(Elementsbyg instance) {
     super(instance, 68);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:peatgrass", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorPeatdirt.block, 1));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPeatgrass.class
