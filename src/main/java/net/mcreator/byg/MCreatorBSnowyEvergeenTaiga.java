 ...
 public class MCreatorBSnowyEvergeenTaiga
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bsnowyevergeentaiga")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSnowyEvergeenTaiga(Elementsbyg instance) {
     super(instance, 823);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.DENSE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Snowy Evergreen Taiga")).setRainfall(0.5F).setBaseHeight(0.85F).setWaterColor(-14329397)
           .setHeightVariation(0.1F).setTemperature(-0.5F));
       setRegistryName("bsnowyevergeentaiga");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSnowyEvergeenTaiga.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSnowyEvergeenTaiga.class
