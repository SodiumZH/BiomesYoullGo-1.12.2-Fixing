 ...
 public class MCreatorWinterscilla
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:winterscilla")
   public static final Block block = null;
   
   public MCreatorWinterscilla(Elementsbyg instance) {
     super(instance, 1192);
   }
 
   
   public void init(FMLInitializationEvent event) {
     OreDictionary.registerOre("flowerLightBlue", block);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:winterscilla", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("winterscilla");
       setRegistryName("winterscilla");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWinterscilla.class
