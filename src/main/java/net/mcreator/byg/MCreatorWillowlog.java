 ...
 public class MCreatorWillowlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:willowlog")
   public static final Block block = null;
   
   public MCreatorWillowlog(Elementsbyg instance) {
     super(instance, 55);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:willowlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("willowlog");
       setUnlocalizedName("willowlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWillowlog.class
