 ...
 public class MCreatorCrocus
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:crocus")
   public static final Block block = null;
   
   public MCreatorCrocus(Elementsbyg instance) {
     super(instance, 676);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:crocus", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("crocus");
       setRegistryName("crocus");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCrocus.class
