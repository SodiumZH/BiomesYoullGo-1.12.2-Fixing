 ...
 public class MCreatorStripped_great_oak_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_great_oak_log")
   public static final Block block = null;
   
   public MCreatorStripped_great_oak_log(Elementsbyg instance) {
     super(instance, 1517);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_great_oak_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_great_oak_log");
       setUnlocalizedName("stripped_great_oak_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_great_oak_log.class
