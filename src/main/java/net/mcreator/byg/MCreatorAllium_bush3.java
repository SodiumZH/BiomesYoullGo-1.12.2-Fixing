 ...
 public class MCreatorAllium_bush3
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:allium_bush3")
   public static final Block block = null;
   
   public MCreatorAllium_bush3(Elementsbyg instance) {
     super(instance, 1287);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:allium_bush3", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("allium_bush3");
       setRegistryName("allium_bush3");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAllium_bush3.class
