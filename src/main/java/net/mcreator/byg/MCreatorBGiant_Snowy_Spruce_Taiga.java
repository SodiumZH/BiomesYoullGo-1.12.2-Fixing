 ...
 public class MCreatorBGiant_Snowy_Spruce_Taiga
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:bgiant_snowy_spruce_taiga")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBGiant_Snowy_Spruce_Taiga(Elementsbyg instance) {
     super(instance, 2339);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBGiant_Snowy_Spruce_Taiga.class
