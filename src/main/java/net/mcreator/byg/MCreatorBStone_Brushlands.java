 ...
 public class MCreatorBStone_Brushlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bstone_brushlands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBStone_Brushlands(Elementsbyg instance) {
     super(instance, 1439);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.COLD, BiomeDictionary.Type.DRY });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Stone Brushlands")).setRainfall(0.5F).setBaseHeight(0.8F).setWaterColor(-12618012)
           .setHeightVariation(0.15F).setTemperature(0.25F));
       setRegistryName("bstone_brushlands");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBStone_Brushlands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBStone_Brushlands.class
