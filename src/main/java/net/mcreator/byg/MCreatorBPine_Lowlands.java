 ...
 public class MCreatorBPine_Lowlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bpine_lowlands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBPine_Lowlands(Elementsbyg instance) {
     super(instance, 1436);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.COLD, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.CONIFEROUS });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Pine Lowlands")).setRainfall(0.5F).setBaseHeight(0.1F).setWaterColor(-12618012).setHeightVariation(0.01F)
           .setTemperature(0.25F));
       setRegistryName("bpine_lowlands");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBPine_Lowlands.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBPine_Lowlands.class
