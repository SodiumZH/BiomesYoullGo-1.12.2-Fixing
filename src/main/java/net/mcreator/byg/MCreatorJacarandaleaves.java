 ...
 public class MCreatorJacarandaleaves
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:jacarandaleaves")
   public static final Block block = null;
   
   public MCreatorJacarandaleaves(Elementsbyg instance) {
     super(instance, 16);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorJacarandaleavesUpdateTick.executeProcedure($_dependencies);
     ...
     public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorJacarandaleavesBlockDestroyedByPlayer.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorJacarandaleaves.class
