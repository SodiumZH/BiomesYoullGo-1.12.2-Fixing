 ...
 public class MCreatorBDeadSea
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bdeadsea")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBDeadSea(Elementsbyg instance) {
     super(instance, 403);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.OCEAN, BiomeDictionary.Type.HOT, BiomeDictionary.Type.SPOOKY, BiomeDictionary.Type.DEAD });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Dead Sea")).setRainfall(0.2F).setBaseHeight(-1.2F).setWaterColor(-16777216).setHeightVariation(0.2F)
           .setTemperature(2.0F));
       setRegistryName("bdeadsea");
       this.topBlock = MCreatorBlacksand.block.getDefaultState();
       this.fillerBlock = MCreatorBlacksand.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBDeadSea.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != MCreatorBlacksand.block.getDefaultState().getBlock() && ground != MCreatorBlacksand.block.getDefaultState()
           .getBlock()) || (ground2 != MCreatorBlacksand.block.getDefaultState().getBlock() && ground2 != MCreatorBlacksand.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), MCreatorBlacksand.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == MCreatorBlacksand.block.getDefaultState().getBlock() || blockType == MCreatorBlacksand.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != MCreatorBlacksand.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, MCreatorBlacksand.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBDeadSea.class
