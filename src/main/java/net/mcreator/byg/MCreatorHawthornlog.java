 ...
 public class MCreatorHawthornlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:hawthornlog")
   public static final Block block = null;
   
   public MCreatorHawthornlog(Elementsbyg instance) {
     super(instance, 996);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:hawthornlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("hawthornlog");
       setUnlocalizedName("hawthornlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorHawthornlog.class
