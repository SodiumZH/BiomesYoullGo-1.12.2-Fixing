 ...
 public class MCreatorPalotree1 extends Elementsbyg.ModElement {
   public MCreatorPalotree1(Elementsbyg instance) {
     super(instance, 363);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 45000) {
       ...
       IBlockState require = Blocks.SAND.getDefaultState();
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPalotree1.class
