 ...
 public class MCreatorGreen_enchanted_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:green_enchanted_gate")
   public static final Block block = null;
   
   public MCreatorGreen_enchanted_gate(Elementsbyg instance) {
     super(instance, 2134);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:green_enchanted_gate", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("green_enchanted_gate");
       setUnlocalizedName("green_enchanted_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorGreenenchantedgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorGreen_enchanted_gate.class
