 ...
 public class MCreatorTamrelitesword
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:tamrelitesword")
   public static final Item block = null;
   
   public MCreatorTamrelitesword(Elementsbyg instance) {
     super(instance, 484);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemSword(EnumHelper.addToolMaterial("TAMRELITESWORD", 1, 750, 4.0F, 1.0F, 8)) {
         ...
         }).setUnlocalizedName("tamrelitesword").setRegistryName("tamrelitesword")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorTamrelitesword.class
