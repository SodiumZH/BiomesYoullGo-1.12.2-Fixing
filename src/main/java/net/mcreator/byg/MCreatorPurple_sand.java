 ...
 public class MCreatorPurple_sand
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:purple_sand")
   public static final Block block = null;
   
   public MCreatorPurple_sand(Elementsbyg instance) {
     super(instance, 1360);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:purple_sand", "inventory"));
   }
   ...
   public static class BlockCustom extends BlockFalling {
     public BlockCustom() {
       ...
       setUnlocalizedName("purple_sand");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPurple_sand.class
