 ...
 public class MCreatorQuagtree1 extends Elementsbyg.ModElement {
   public MCreatorQuagtree1(Elementsbyg instance) {
     super(instance, 388);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 100000) {
       ...
       IBlockState require = MCreatorPeatgrass.block.getDefaultState();
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "quag_tree2"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorQuagtree1.class
