 ...
 public class MCreatorBBorealForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bborealforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBBorealForest(Elementsbyg instance) {
     super(instance, 186);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.COLD, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.DENSE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Boreal Forest")).setRainfall(0.5F).setBaseHeight(0.75F).setWaterColor(-12618012).setHeightVariation(0.1F)
           .setTemperature(0.3F));
       setRegistryName("bborealforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBBorealForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBBorealForest.class
