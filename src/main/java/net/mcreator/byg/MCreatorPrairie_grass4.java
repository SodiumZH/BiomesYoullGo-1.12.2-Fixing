 ...
 public class MCreatorPrairie_grass4
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:prairie_grass4")
   public static final Block block = null;
   
   public MCreatorPrairie_grass4(Elementsbyg instance) {
     super(instance, 1296);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:prairie_grass4", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("prairie_grass4");
       setRegistryName("prairie_grass4");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPrairie_grass4.class
