 ...
 public class MCreatorBPineMountains
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bpinemountains")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBPineMountains(Elementsbyg instance) {
     super(instance, 204);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.COLD, BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.HILLS });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Pine Mountains")).setRainfall(0.5F).setBaseHeight(2.0F).setWaterColor(-12618012).setHeightVariation(0.55F)
           .setTemperature(0.25F));
       setRegistryName("bpinemountains");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBPineMountains.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBPineMountains.class
