 ...
 public class MCreatorBaobab_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:baobab_gate")
   public static final Block block = null;
   
   public MCreatorBaobab_gate(Elementsbyg instance) {
     super(instance, 1720);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:baobab_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("baobab_gate");
       setUnlocalizedName("baobab_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorBaobabgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBaobab_gate.class
