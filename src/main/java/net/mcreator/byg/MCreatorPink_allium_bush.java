 ...
 public class MCreatorPink_allium_bush
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pink_allium_bush")
   public static final Block block = null;
   
   public MCreatorPink_allium_bush(Elementsbyg instance) {
     super(instance, 1606);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:pink_allium_bush", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("pink_allium_bush");
       setRegistryName("pink_allium_bush");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPink_allium_bush.class
