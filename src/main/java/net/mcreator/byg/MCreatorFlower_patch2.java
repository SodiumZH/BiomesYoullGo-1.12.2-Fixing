 ...
 public class MCreatorFlower_patch2 extends Elementsbyg.ModElement {
   public MCreatorFlower_patch2(Elementsbyg instance) {
     super(instance, 2406);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       IBlockState require = MCreatorMeadowgrass.block.getDefaultState();
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bmeadow")))
         biomeCriteria = true; 
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bfloweringplains")))
         biomeCriteria = true; 
       if (!biomeCriteria)
         return; 
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "flower_patch"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFlower_patch2.class
