 ...
 public class MCreatorJacarandalog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:jacarandalog")
   public static final Block block = null;
   
   public MCreatorJacarandalog(Elementsbyg instance) {
     super(instance, 17);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:jacarandalog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("jacarandalog");
       setUnlocalizedName("jacarandalog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorJacarandalog.class
