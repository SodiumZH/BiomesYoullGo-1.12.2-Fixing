 ...
 public class MCreatorNetherfurnacelit extends Elementsbyg.ModElement {
   @ObjectHolder("byg:netherfurnacelit")
   public static final Block block = null;
   
   public MCreatorNetherfurnacelit(Elementsbyg instance) {
     super(instance, 644);
   }
   ...
   public static class BlockCustom extends Block implements ITileEntityProvider {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorNetherfurnace.block, 1));
     }
 
     
     public TileEntity createNewTileEntity(World worldIn, int meta) {
       return (TileEntity)new MCreatorNetherfurnacelit.TileEntityCustom();
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorNetherfurnacelitUpdateTick.executeProcedure($_dependencies);
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorNetherfurnaceGUIprocedure.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorNetherfurnacelit.class
