 ...
 public class MCreatorBTropicalRainforest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:btropicalrainforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBTropicalRainforest(Elementsbyg instance) {
     super(instance, 203);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.HOT, BiomeDictionary.Type.WET, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.JUNGLE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Tropical Rainforest")).setRainfall(0.7F).setBaseHeight(0.5F).setWaterColor(-10388636)
           .setHeightVariation(0.25F).setTemperature(0.95F));
       setRegistryName("btropicalrainforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBTropicalRainforest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBTropicalRainforest.class
