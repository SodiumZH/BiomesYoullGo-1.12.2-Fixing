 ...
 public class MCreatorBDunes
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bdunes")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBDunes(Elementsbyg instance) {
     super(instance, 213);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.HILLS, BiomeDictionary.Type.SANDY, BiomeDictionary.Type.HOT, BiomeDictionary.Type.DRY });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Dunes")).setRainfall(0.5F).setBaseHeight(1.3F).setWaterColor(-1247598).setHeightVariation(0.5F)
           .setTemperature(2.0F));
       setRegistryName("bdunes");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBDunes.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBDunes.class
