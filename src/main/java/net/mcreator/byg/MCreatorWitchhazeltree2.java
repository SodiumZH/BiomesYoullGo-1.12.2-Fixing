 ...
 public class MCreatorWitchhazeltree2 extends Elementsbyg.ModElement {
   public MCreatorWitchhazeltree2(Elementsbyg instance) {
     super(instance, 844);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 200000) {
       ...
       IBlockState require = MCreatorPeatdirt.block.getDefaultState();
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "weepingtree_fallen"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWitchhazeltree2.class
