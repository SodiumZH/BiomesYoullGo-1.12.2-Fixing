 ...
 public class MCreatorWhiteanemone
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:whiteanemone")
   public static final Block block = null;
   
   public MCreatorWhiteanemone(Elementsbyg instance) {
     super(instance, 1114);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:whiteanemone", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("whiteanemone");
       setRegistryName("whiteanemone");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWhiteanemone.class
