 ...
 public class MCreatorCikatree2 extends Elementsbyg.ModElement {
   public MCreatorCikatree2(Elementsbyg instance) {
     super(instance, 232);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = MCreatorPeatdirt.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       if (!blockCriteria)
         return; 
       ...
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "cikatree2"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCikatree2.class
