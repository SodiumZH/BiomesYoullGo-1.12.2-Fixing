 ...
 public class MCreatorHawthornsapling
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:hawthornsapling")
   public static final Block block = null;
   
   public MCreatorHawthornsapling(Elementsbyg instance) {
     super(instance, 1018);
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorHawthornsaplingUpdateTick.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorHawthornsaplingOnBlockRightclicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorHawthornsapling.class
