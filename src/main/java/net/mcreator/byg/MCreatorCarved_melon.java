 ...
 public class MCreatorCarved_melon extends Elementsbyg.ModElement {
   @ObjectHolder("byg:carved_melon")
   public static final Block block = null;
   
   public MCreatorCarved_melon(Elementsbyg instance) {
     super(instance, 2385);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:carved_melon", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setUnlocalizedName("carved_melon");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCarved_melon.class
