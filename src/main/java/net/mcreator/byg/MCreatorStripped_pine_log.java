 ...
 public class MCreatorStripped_pine_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_pine_log")
   public static final Block block = null;
   
   public MCreatorStripped_pine_log(Elementsbyg instance) {
     super(instance, 1533);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_pine_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_pine_log");
       setUnlocalizedName("stripped_pine_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_pine_log.class
