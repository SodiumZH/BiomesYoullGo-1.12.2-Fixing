 ...
 public class MCreatorBCikaForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bcikaforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBCikaForest(Elementsbyg instance) {
     super(instance, 177);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.COLD, BiomeDictionary.Type.FOREST });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Cika Forest")).setRainfall(0.4F).setBaseHeight(0.8F).setWaterColor(-12618012).setHeightVariation(0.02F)
           .setTemperature(0.25F));
       setRegistryName("bcikaforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBCikaForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBCikaForest.class
