 ...
 public class MCreatorBZelkovaForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bzelkovaforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBZelkovaForest(Elementsbyg instance) {
     super(instance, 182);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.COLD, BiomeDictionary.Type.CONIFEROUS });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Zelkova Forest")).setRainfall(0.5F).setBaseHeight(0.85F).setWaterColor(-12618012)
           .setHeightVariation(0.03F).setTemperature(0.25F));
       setRegistryName("bzelkovaforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBZelkovaForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBZelkovaForest.class
