 ...
 public class MCreatorTamreliteshovel
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:tamreliteshovel")
   public static final Item block = null;
   
   public MCreatorTamreliteshovel(Elementsbyg instance) {
     super(instance, 487);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemSpade(EnumHelper.addToolMaterial("TAMRELITESHOVEL", 2, 750, 6.0F, 1.0F, 8)) {
         ...
         }).setUnlocalizedName("tamreliteshovel").setRegistryName("tamreliteshovel")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorTamreliteshovel.class
