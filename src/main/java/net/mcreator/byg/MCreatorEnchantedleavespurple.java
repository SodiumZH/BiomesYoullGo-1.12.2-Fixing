 ...
 public class MCreatorEnchantedleavespurple
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:enchantedleavespurple")
   public static final Block block = null;
   
   public MCreatorEnchantedleavespurple(Elementsbyg instance) {
     super(instance, 10);
   }
   ...
   public static class BlockCustom
     ...
     public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
       ...
       MCreatorEnchantedleavespurpleBlockDestroyedByPlayer.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorEnchantedleavespurple.class
