 ...
 public class MCreatorSalal_bush
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:salal_bush")
   public static final Block block = null;
   
   public MCreatorSalal_bush(Elementsbyg instance) {
     super(instance, 2359);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:salal_bush", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("salal_bush");
       setRegistryName("salal_bush");
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorSalalbushUpdateTick.executeProcedure($_dependencies);
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSalal_bush.class
