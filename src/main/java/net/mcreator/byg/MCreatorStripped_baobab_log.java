 ...
 public class MCreatorStripped_baobab_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_baobab_log")
   public static final Block block = null;
   
   public MCreatorStripped_baobab_log(Elementsbyg instance) {
     super(instance, 1508);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setUnlocalizedName("stripped_baobab_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_baobab_log.class
