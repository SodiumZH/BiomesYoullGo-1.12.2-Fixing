 ...
 public class MCreatorPlant_stem extends Elementsbyg.ModElement {
   @ObjectHolder("byg:plant_stem")
   public static final Block block = null;
   
   public MCreatorPlant_stem(Elementsbyg instance) {
     super(instance, 2300);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:plant_stem", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("plant_stem");
       setUnlocalizedName("plant_stem");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPlant_stem.class
