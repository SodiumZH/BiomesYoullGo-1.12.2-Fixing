 ...
 public class MCreatorCanyon_crystal_Bottom1 extends Elementsbyg.ModElement {
   public MCreatorCanyon_crystal_Bottom1(Elementsbyg instance) {
     super(instance, 2402);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       IBlockState require = MCreatorCracked_sand.block.getDefaultState();
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bcrystal_canyons")))
         biomeCriteria = true; 
       if (!biomeCriteria)
         return; 
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "canyon_crystal_bottom1"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCanyon_crystal_Bottom1.class
