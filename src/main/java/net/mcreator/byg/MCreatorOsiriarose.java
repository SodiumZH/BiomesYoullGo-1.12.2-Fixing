 ...
 public class MCreatorOsiriarose
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:osiriarose")
   public static final Block block = null;
   
   public MCreatorOsiriarose(Elementsbyg instance) {
     super(instance, 1618);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:osiriarose", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("osiriarose");
       setRegistryName("osiriarose");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorOsiriarose.class
