 ...
 public class MCreatorJapanese_orchid
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:japanese_orchid")
   public static final Block block = null;
   
   public MCreatorJapanese_orchid(Elementsbyg instance) {
     super(instance, 1619);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:japanese_orchid", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("japanese_orchid");
       setRegistryName("japanese_orchid");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorJapanese_orchid.class
