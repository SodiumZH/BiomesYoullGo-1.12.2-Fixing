 ...
 public class MCreatorPrairie_grass5
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:prairie_grass5")
   public static final Block block = null;
   
   public MCreatorPrairie_grass5(Elementsbyg instance) {
     super(instance, 1297);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:prairie_grass5", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("prairie_grass5");
       setRegistryName("prairie_grass5");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPrairie_grass5.class
