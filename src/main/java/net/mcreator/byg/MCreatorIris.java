 ...
 public class MCreatorIris
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:iris")
   public static final Block block = null;
   
   public MCreatorIris(Elementsbyg instance) {
     super(instance, 2351);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:iris", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("iris");
       setRegistryName("iris");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorIris.class
