 ...
 public class MCreatorWitchhazellog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:witchhazellog")
   public static final Block block = null;
   
   public MCreatorWitchhazellog(Elementsbyg instance) {
     super(instance, 825);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:witchhazellog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("witchhazellog");
       setUnlocalizedName("witchhazellog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWitchhazellog.class
