 ...
 public class MCreatorBlue_enchanted_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blue_enchanted_gate")
   public static final Block block = null;
   
   public MCreatorBlue_enchanted_gate(Elementsbyg instance) {
     super(instance, 2120);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:blue_enchanted_gate", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("blue_enchanted_gate");
       setUnlocalizedName("blue_enchanted_gate");
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MCreatorBlueenchantedgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlue_enchanted_gate.class
