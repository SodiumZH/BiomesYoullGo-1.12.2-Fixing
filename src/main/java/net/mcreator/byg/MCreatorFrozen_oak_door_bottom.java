 ...
 public class MCreatorFrozen_oak_door_bottom
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:frozen_oak_door_bottom")
   public static final Block block = null;
   
   public MCreatorFrozen_oak_door_bottom(Elementsbyg instance) {
     super(instance, 1839);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:frozen_oak_door_bottom", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("frozen_oak_door_bottom");
       setUnlocalizedName("frozen_oak_door_bottom");
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       MCreatorFrozenoakdoorbottomNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorFrozenoakdoorbottomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFrozen_oak_door_bottom.class
