 ...
 public class MCreatorFoxglove
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:foxglove")
   public static final Block block = null;
   
   public MCreatorFoxglove(Elementsbyg instance) {
     super(instance, 674);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:foxglove", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFoxglove.class
