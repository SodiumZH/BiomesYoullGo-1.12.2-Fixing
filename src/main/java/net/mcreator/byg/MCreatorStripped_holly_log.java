 ...
 public class MCreatorStripped_holly_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_holly_log")
   public static final Block block = null;
   
   public MCreatorStripped_holly_log(Elementsbyg instance) {
     super(instance, 1548);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_holly_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_holly_log");
       setUnlocalizedName("stripped_holly_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_holly_log.class
