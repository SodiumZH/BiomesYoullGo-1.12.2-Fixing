 ...
 public class MCreatorPinkallium
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pinkallium")
   public static final Block block = null;
   
   public MCreatorPinkallium(Elementsbyg instance) {
     super(instance, 76);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:pinkallium", "inventory"));
   }
   ...
   public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bjacarandaforest")))
       biomeCriteria = true; 
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("pinkallium");
       setRegistryName("pinkallium");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPinkallium.class
