 ...
 public class MCreatorBMapleForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bmapleforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBMapleForest(Elementsbyg instance) {
     super(instance, 191);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Maple Taiga")).setRainfall(0.5F).setBaseHeight(0.65F).setWaterColor(-12618012).setHeightVariation(0.1F)
           .setTemperature(0.25F));
       setRegistryName("bmapleforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBMapleForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBMapleForest.class
