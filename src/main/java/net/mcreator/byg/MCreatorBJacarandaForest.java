 ...
 public class MCreatorBJacarandaForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bjacarandaforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBJacarandaForest(Elementsbyg instance) {
     super(instance, 176);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Jacaranda Forest")).setRainfall(0.5F).setBaseHeight(0.6F).setWaterColor(-12618012)
           .setHeightVariation(0.03F).setTemperature(0.7F));
       setRegistryName("bjacarandaforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBJacarandaForest.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == MCreatorJacarandalog.block.getDefaultState().getBlock() || blockType == MCreatorJacarandaleaves.block
         ...
         .getDefaultState().getBlock() || blockType == Blocks.DIRT.getDefaultState().getBlock());
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBJacarandaForest.class
