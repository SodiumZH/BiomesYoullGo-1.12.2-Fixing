 ...
 public class MCreatorWintercyclamen
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:wintercyclamen")
   public static final Block block = null;
   
   public MCreatorWintercyclamen(Elementsbyg instance) {
     super(instance, 838);
   }
 
   
   public void init(FMLInitializationEvent event) {
     OreDictionary.registerOre("flowerCyan", block);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:wintercyclamen", "inventory"));
   }
   ...
   public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bweepingwitchforest")))
       biomeCriteria = true; 
     if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bfrostyforest")))
       biomeCriteria = true; 
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("wintercyclamen");
       setRegistryName("wintercyclamen");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWintercyclamen.class
