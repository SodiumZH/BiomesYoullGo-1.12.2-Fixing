 ...
 public class MCreatorBSnowyConiferousForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bsnowyconiferousforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSnowyConiferousForest(Elementsbyg instance) {
     super(instance, 849);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.CONIFEROUS });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Snowy Coniferous Forest")).setRainfall(0.6F).setBaseHeight(0.85F).setWaterColor(-14329397)
           .setHeightVariation(0.1F).setTemperature(-0.5F));
       setRegistryName("bsnowyconiferousforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSnowyConiferousForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSnowyConiferousForest.class
