 ...
 public class MCreatorBGiant_Seasonal_Spruce_Taiga
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:bgiant_seasonal_spruce_taiga")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBGiant_Seasonal_Spruce_Taiga(Elementsbyg instance) {
     super(instance, 1312);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBGiant_Seasonal_Spruce_Taiga.class
