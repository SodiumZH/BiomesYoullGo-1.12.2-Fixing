 ...
 public class MCreatorStripped_ironwood_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_ironwood_log")
   public static final Block block = null;
   
   public MCreatorStripped_ironwood_log(Elementsbyg instance) {
     super(instance, 1569);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_ironwood_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_ironwood_log");
       setUnlocalizedName("stripped_ironwood_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_ironwood_log.class
