 ...
 public class MCreatorBCherryGrove
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bcherrygrove")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBCherryGrove(Elementsbyg instance) {
     super(instance, 193);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Cherry Grove")).setRainfall(0.6F).setBaseHeight(0.55F).setWaterColor(-13281615).setHeightVariation(0.2F)
           .setTemperature(0.75F));
       setRegistryName("bcherrygrove");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBCherryGrove.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBCherryGrove.class
