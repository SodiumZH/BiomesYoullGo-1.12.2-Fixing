 ...
 public class MCreatorBSonoranDesert
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bsonorandesert")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBSonoranDesert(Elementsbyg instance) {
     super(instance, 202);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.HOT, BiomeDictionary.Type.DRY, BiomeDictionary.Type.SANDY });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Sonoran Desert")).setRainfall(0.1F).setBaseHeight(0.2F).setWaterColor(-14187104).setHeightVariation(0.1F)
           .setTemperature(2.0F));
       setRegistryName("bsonorandesert");
       this.topBlock = Blocks.SAND.getStateFromMeta(0);
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBSonoranDesert.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Blocks.SAND.getStateFromMeta(0).getBlock() && ground != Blocks.SAND.getStateFromMeta(0).getBlock()) || (ground2 != Blocks.SAND
           .getStateFromMeta(0).getBlock() && ground2 != Blocks.SAND.getStateFromMeta(0).getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Blocks.SAND.getStateFromMeta(0), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Blocks.SAND.getStateFromMeta(0).getBlock() || blockType == Blocks.SAND
         .getStateFromMeta(0).getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Blocks.SAND.getStateFromMeta(0).getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Blocks.SAND.getStateFromMeta(0));
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBSonoranDesert.class
