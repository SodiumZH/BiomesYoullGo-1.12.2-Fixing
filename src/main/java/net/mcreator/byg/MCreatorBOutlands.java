 ...
 public class MCreatorBOutlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:boutlands")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBOutlands(Elementsbyg instance) {
     super(instance, 1372);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Outlands")).setRainfall(0.1F).setBaseHeight(0.55F).setWaterColor(-2893433).setHeightVariation(0.1F)
           .setTemperature(2.0F));
       setRegistryName("boutlands");
       this.topBlock = MCreatorCracked_sand.block.getDefaultState();
       this.fillerBlock = MCreatorCracked_sand.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBOutlands.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != MCreatorCracked_sand.block.getDefaultState().getBlock() && ground != MCreatorCracked_sand.block
           .getDefaultState().getBlock()) || (ground2 != MCreatorCracked_sand.block.getDefaultState().getBlock() && ground2 != MCreatorCracked_sand.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), MCreatorCracked_sand.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == MCreatorCracked_sand.block.getDefaultState().getBlock() || blockType == MCreatorCracked_sand.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != MCreatorCracked_sand.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, MCreatorCracked_sand.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBOutlands.class
