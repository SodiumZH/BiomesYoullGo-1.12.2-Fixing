 ...
 public class MCreatorPolished_sodalite_stairs
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:polished_sodalite_stairs")
   public static final Block block = null;
   
   public MCreatorPolished_sodalite_stairs(Elementsbyg instance) {
     super(instance, 1746);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPolished_sodalite_stairs.class
