 ...
 public class MCreatorPrairie_grass
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:prairie_grass")
   public static final Block block = null;
   
   public MCreatorPrairie_grass(Elementsbyg instance) {
     super(instance, 1255);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:prairie_grass", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("prairie_grass");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPrairie_grass.class
