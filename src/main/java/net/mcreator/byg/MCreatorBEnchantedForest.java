 ...
 public class MCreatorBEnchantedForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:benchantedforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBEnchantedForest(Elementsbyg instance) {
     super(instance, 901);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.MAGICAL, BiomeDictionary.Type.RARE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Enchanted Forest")).setRainfall(0.5F).setBaseHeight(0.6F).setWaterColor(-6668618)
           .setHeightVariation(0.15F).setTemperature(0.6F));
       setRegistryName("benchantedforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBEnchantedForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBEnchantedForest.class
