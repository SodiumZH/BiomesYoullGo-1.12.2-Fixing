 ...
 public class MCreatorPrairie_grass3
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:prairie_grass3")
   public static final Block block = null;
   
   public MCreatorPrairie_grass3(Elementsbyg instance) {
     super(instance, 1295);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:prairie_grass3", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("prairie_grass3");
       setRegistryName("prairie_grass3");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPrairie_grass3.class
