 ...
 public class MCreatorStripped_skyris_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_skyris_log")
   public static final Block block = null;
   
   public MCreatorStripped_skyris_log(Elementsbyg instance) {
     super(instance, 1536);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_skyris_log.class
