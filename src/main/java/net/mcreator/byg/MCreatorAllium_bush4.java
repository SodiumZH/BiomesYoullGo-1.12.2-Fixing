 ...
 public class MCreatorAllium_bush4
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:allium_bush4")
   public static final Block block = null;
   
   public MCreatorAllium_bush4(Elementsbyg instance) {
     super(instance, 1288);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:allium_bush4", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("allium_bush4");
       setRegistryName("allium_bush4");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAllium_bush4.class
