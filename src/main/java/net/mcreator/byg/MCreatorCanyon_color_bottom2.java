 ...
 public class MCreatorCanyon_color_bottom2 extends Elementsbyg.ModElement {
   public MCreatorCanyon_color_bottom2(Elementsbyg instance) {
     super(instance, 2401);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 500000) {
       ...
       IBlockState require = MCreatorRed_cracked_sand.block.getDefaultState();
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(biome)).equals(new ResourceLocation("byg:bcolored_canyons")))
         biomeCriteria = true; 
       if (!biomeCriteria)
         return; 
       if (world.isRemote)
         return; 
       Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("byg", "canyon_color_bottom2"));
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorCanyon_color_bottom2.class
