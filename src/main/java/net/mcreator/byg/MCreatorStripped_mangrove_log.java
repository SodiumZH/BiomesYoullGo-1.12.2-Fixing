 ...
 public class MCreatorStripped_mangrove_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_mangrove_log")
   public static final Block block = null;
   
   public MCreatorStripped_mangrove_log(Elementsbyg instance) {
     super(instance, 1526);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_mangrove_log", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_mangrove_log.class
