 ...
 public class MCreatorThornblock
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:thornblock")
   public static final Block block = null;
   
   public MCreatorThornblock(Elementsbyg instance) {
     super(instance, 2294);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("thornblock");
       setUnlocalizedName("thornblock");
     ...
     public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
       ...
       MCreatorThornblockEntityCollidesInTheBlock.executeProcedure($_dependencies);
     }
     ...
     public void onEntityWalk(World world, BlockPos pos, Entity entity) {
       ...
       HashMap<String, Object> $_dependencies = new HashMap<>();
       $_dependencies.put("entity", entity);
       MCreatorThornblockEntityWalksOnTheBlock.executeProcedure($_dependencies);
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorThornblock.class
