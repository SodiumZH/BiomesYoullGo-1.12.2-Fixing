 ...
 public class MCreatorLathariumbattleaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:lathariumbattleaxe")
   public static final Item block = null;
   
   public MCreatorLathariumbattleaxe(Elementsbyg instance) {
     super(instance, 941);
   }
     ...
     this.elements.items.add(() -> ((Item)(new ItemToolCustom()
         {
           public boolean hitEntity(ItemStack itemstack, EntityLivingBase entity, EntityLivingBase entity2) {
             ...
             MCreatorLathariumswordMobIsHitWithTool.executeProcedure((HashMap)$_dependencies);
             
             return true;
           }
         }).setUnlocalizedName("lathariumbattleaxe").setRegistryName("lathariumbattleaxe")).setCreativeTab(MCreatorBYG.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorLathariumbattleaxe.class
