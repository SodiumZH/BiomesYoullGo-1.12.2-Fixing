 ...
 public class MCreatorRockystone2
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rockystone2")
   public static final Block block = null;
   
   public MCreatorRockystone2(Elementsbyg instance) {
     super(instance, 1437);
   }
       ...
       (new WorldGenMinable(block.getDefaultState(), 32, new Predicate<IBlockState>() {
             public boolean apply(IBlockState blockAt) {
               ...
               if (blockAt.getBlock() == MCreatorPeatgrass.block.getDefaultState().getBlock())
                 blockCriteria = true; 
               if (blockAt.getBlock() == MCreatorRocky_grass.block.getDefaultState().getBlock())
                 blockCriteria = true; 
   ...
   public static class BlockCustom extends Block {
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(MCreatorRockystone.block, 1);
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorRockystone2.class
