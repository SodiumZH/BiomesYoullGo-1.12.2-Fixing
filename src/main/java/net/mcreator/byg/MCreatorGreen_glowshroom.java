 ...
 public class MCreatorGreen_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:green_glowshroom")
   public static final Block block = null;
   
   public MCreatorGreen_glowshroom(Elementsbyg instance) {
     super(instance, 1315);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:green_glowshroom", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setRegistryName("green_glowshroom");
       setUnlocalizedName("green_glowshroom");
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorGreenglowshroomitem.block, 4));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorGreen_glowshroom.class
