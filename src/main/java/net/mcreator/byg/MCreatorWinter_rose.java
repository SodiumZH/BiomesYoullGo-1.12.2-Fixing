 ...
 public class MCreatorWinter_rose
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:winter_rose")
   public static final Block block = null;
   
   public MCreatorWinter_rose(Elementsbyg instance) {
     super(instance, 2364);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:winter_rose", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.8F);
       setUnlocalizedName("winter_rose");
       setRegistryName("winter_rose");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorWinter_rose.class
