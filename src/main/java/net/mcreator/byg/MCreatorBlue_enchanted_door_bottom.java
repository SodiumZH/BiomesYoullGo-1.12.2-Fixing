 ...
 public class MCreatorBlue_enchanted_door_bottom
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blue_enchanted_door_bottom")
   public static final Block block = null;
   
   public MCreatorBlue_enchanted_door_bottom(Elementsbyg instance) {
     super(instance, 1777);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:blue_enchanted_door_bottom", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("blue_enchanted_door_bottom");
       setUnlocalizedName("blue_enchanted_door_bottom");
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       MCreatorBlueenchanteddoorbottomNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorBlueenchanteddoorbottomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlue_enchanted_door_bottom.class
