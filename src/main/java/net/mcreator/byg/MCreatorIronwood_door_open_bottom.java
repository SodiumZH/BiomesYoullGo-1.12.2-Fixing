 ...
 public class MCreatorIronwood_door_open_bottom
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:ironwood_door_open_bottom")
   public static final Block block = null;
   
   public MCreatorIronwood_door_open_bottom(Elementsbyg instance) {
     super(instance, 1871);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:ironwood_door_open_bottom", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("ironwood_door_open_bottom");
       setUnlocalizedName("ironwood_door_open_bottom");
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       MCreatorIronwooddooropenbottomNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MCreatorIronwooddooropenbottomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorIronwood_door_open_bottom.class
