 ...
 public class MCreatorPendoriteaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pendoriteaxe")
   public static final Item block = null;
   
   public MCreatorPendoriteaxe(Elementsbyg instance) {
     super(instance, 519);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemToolCustom() {
         ...
         }).setUnlocalizedName("pendoriteaxe").setRegistryName("pendoriteaxe")).setCreativeTab(MCreatorBYG.tab));
   }
   
   @SideOnly(Side.CLIENT)
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("byg:pendoriteaxe", "inventory"));
   }
   ...
   private static class ItemToolCustom extends ItemTool {
     ...
     protected ItemToolCustom() {
       super(EnumHelper.addToolMaterial("PENDORITEAXE", 1, 1200, 12.0F, 6.0F, 15), effective_items_set);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPendoriteaxe.class
