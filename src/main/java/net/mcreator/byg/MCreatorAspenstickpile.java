 ...
 public class MCreatorAspenstickpile extends Elementsbyg.ModElement {
   @ObjectHolder("byg:aspenstickpile")
   public static final Block block = null;
   
   public MCreatorAspenstickpile(Elementsbyg instance) {
     super(instance, 2373);
   }
   ...
   public void init(FMLInitializationEvent event) {
     OreDictionary.registerOre("stickWood", block);
   }
 
   
   @SideOnly(Side.CLIENT)
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:aspenstickpile", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("aspenstickpile");
       setUnlocalizedName("aspenstickpile");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorAspenstickpile.class
