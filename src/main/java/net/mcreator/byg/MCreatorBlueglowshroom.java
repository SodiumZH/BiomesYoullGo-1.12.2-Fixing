 ...
 public class MCreatorBlueglowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blueglowshroom")
   public static final Block block = null;
   
   public MCreatorBlueglowshroom(Elementsbyg instance) {
     super(instance, 1313);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:blueglowshroom", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setRegistryName("blueglowshroom");
       setUnlocalizedName("blueglowshroom");
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorBlueglowshroomitem.block, 4));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBlueglowshroom.class
