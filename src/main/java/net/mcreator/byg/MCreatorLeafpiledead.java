 ...
 public class MCreatorLeafpiledead extends Elementsbyg.ModElement {
   @ObjectHolder("byg:leafpiledead")
   public static final Block block = null;
   
   public MCreatorLeafpiledead(Elementsbyg instance) {
     super(instance, 95);
   }
   ...
   public void init(FMLInitializationEvent event) {
     OreDictionary.registerOre("leafpile", block);
   }
 
   
   @SideOnly(Side.CLIENT)
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:leafpiledead", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setRegistryName("leafpiledead");
       setUnlocalizedName("leafpiledead");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorLeafpiledead.class
