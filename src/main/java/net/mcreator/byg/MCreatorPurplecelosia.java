 ...
 public class MCreatorPurplecelosia
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:purplecelosia")
   public static final Block block = null;
   
   public MCreatorPurplecelosia(Elementsbyg instance) {
     super(instance, 1198);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:purplecelosia", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("purplecelosia");
       setRegistryName("purplecelosia");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPurplecelosia.class
