 ...
 public class MCreatorBGlowshroomBayou
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bglowshroombayou")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBGlowshroomBayou(Elementsbyg instance) {
     super(instance, 897);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.WET, BiomeDictionary.Type.MAGICAL, BiomeDictionary.Type.RARE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Glowshroom Bayou")).setRainfall(0.5F).setBaseHeight(-0.4F).setWaterColor(-10388636)
           .setHeightVariation(0.01F).setTemperature(0.8F));
       setRegistryName("bglowshroombayou");
       ...
       this.decorator.reedsPerChunk = 23;
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBGlowshroomBayou.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBGlowshroomBayou.class
