 ...
 public class MCreatorSodalite_brick_stairs
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:sodalite_brick_stairs")
   public static final Block block = null;
   
   public MCreatorSodalite_brick_stairs(Elementsbyg instance) {
     super(instance, 1748);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSodalite_brick_stairs.class
