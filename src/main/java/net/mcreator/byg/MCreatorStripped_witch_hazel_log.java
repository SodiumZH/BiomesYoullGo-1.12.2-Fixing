 ...
 public class MCreatorStripped_witch_hazel_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_witch_hazel_log")
   public static final Block block = null;
   
   public MCreatorStripped_witch_hazel_log(Elementsbyg instance) {
     super(instance, 1551);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_witch_hazel_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_witch_hazel_log");
       setUnlocalizedName("stripped_witch_hazel_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_witch_hazel_log.class
