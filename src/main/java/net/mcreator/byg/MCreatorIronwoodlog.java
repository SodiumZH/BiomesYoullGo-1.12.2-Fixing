 ...
 public class MCreatorIronwoodlog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:ironwoodlog")
   public static final Block block = null;
   
   public MCreatorIronwoodlog(Elementsbyg instance) {
     super(instance, 1001);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:ironwoodlog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("ironwoodlog");
       setUnlocalizedName("ironwoodlog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorIronwoodlog.class
