 ...
 public class MCreatorBConiferousForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bconiferousforest")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBConiferousForest(Elementsbyg instance) {
     super(instance, 205);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.COLD });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Coniferous Forest")).setRainfall(0.5F).setBaseHeight(0.7F).setWaterColor(-12618012)
           .setHeightVariation(0.15F).setTemperature(0.25F));
       setRegistryName("bconiferousforest");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBConiferousForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBConiferousForest.class
