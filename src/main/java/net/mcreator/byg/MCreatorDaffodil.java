 ...
 public class MCreatorDaffodil
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:daffodil")
   public static final Block block = null;
   
   public MCreatorDaffodil(Elementsbyg instance) {
     super(instance, 1607);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:daffodil", "inventory"));
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     public BlockCustomFlower() {
       ...
       setResistance(2.0F);
       setLightLevel(0.0F);
       setUnlocalizedName("daffodil");
       setRegistryName("daffodil");
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorDaffodil.class
