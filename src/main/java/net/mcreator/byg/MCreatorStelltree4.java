 ...
 public class MCreatorStelltree4 extends Elementsbyg.ModElement {
   public MCreatorStelltree4(Elementsbyg instance) {
     super(instance, 336);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 100000) {
       ...
       IBlockState require = MCreatorPasturegrass.block.getDefaultState();
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStelltree4.class
