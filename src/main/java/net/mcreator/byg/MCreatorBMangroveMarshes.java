 ...
 public class MCreatorBMangroveMarshes
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bmangrovemarshes")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBMangroveMarshes(Elementsbyg instance) {
     super(instance, 188);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Mangrove Marshes")).setRainfall(0.7F).setBaseHeight(-0.4F).setWaterColor(-12210702)
           .setHeightVariation(0.01F).setTemperature(0.8F));
       setRegistryName("bmangrovemarshes");
       this.topBlock = MCreatorWhitesand.block.getDefaultState();
       this.fillerBlock = MCreatorWhitesand.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBMangroveMarshes.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != MCreatorWhitesand.block.getDefaultState().getBlock() && ground != MCreatorWhitesand.block.getDefaultState()
           .getBlock()) || (ground2 != MCreatorWhitesand.block.getDefaultState().getBlock() && ground2 != MCreatorWhitesand.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), MCreatorWhitesand.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == MCreatorWhitesand.block.getDefaultState().getBlock() || blockType == MCreatorWhitesand.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != MCreatorWhitesand.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, MCreatorWhitesand.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBMangroveMarshes.class
