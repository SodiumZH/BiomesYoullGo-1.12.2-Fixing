 ...
 public class MCreatorFirecracker
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:firecracker")
   public static final Block block = null;
   
   public MCreatorFirecracker(Elementsbyg instance) {
     super(instance, 79);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:firecracker", "inventory"));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorFirecracker.class
