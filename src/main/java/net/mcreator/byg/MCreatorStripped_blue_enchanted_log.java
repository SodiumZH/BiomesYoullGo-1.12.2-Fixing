 ...
 public class MCreatorStripped_blue_enchanted_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_blue_enchanted_log")
   public static final Block block = null;
   
   public MCreatorStripped_blue_enchanted_log(Elementsbyg instance) {
     super(instance, 1511);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_blue_enchanted_log", "inventory"));
   }
   ...
   public static class BlockCustom
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("stripped_blue_enchanted_log");
       setUnlocalizedName("stripped_blue_enchanted_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_blue_enchanted_log.class
