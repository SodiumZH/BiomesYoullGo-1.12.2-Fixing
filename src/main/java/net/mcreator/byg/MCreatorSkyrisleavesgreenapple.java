 ...
 public class MCreatorSkyrisleavesgreenapple
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:skyrisleavesgreenapple")
   public static final Block block = null;
   
   public MCreatorSkyrisleavesgreenapple(Elementsbyg instance) {
     super(instance, 43);
   }
   ...
   public static class BlockCustom
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorGreenapple.block, 1));
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       MCreatorSkyrisleavesgreenappleUpdateTick.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSkyrisleavesgreenapple.class
