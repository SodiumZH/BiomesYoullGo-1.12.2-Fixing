 ...
 public class MCreatorBAmaranth_Fields
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bamaranth_fields")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBAmaranth_Fields(Elementsbyg instance) {
     super(instance, 1251);
   }
   ...
   static class BiomeGenCustom extends Biome {
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBAmaranth_Fields.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBAmaranth_Fields.class
