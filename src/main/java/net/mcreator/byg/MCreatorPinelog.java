 ...
 public class MCreatorPinelog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:pinelog")
   public static final Block block = null;
   
   public MCreatorPinelog(Elementsbyg instance) {
     super(instance, 40);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:pinelog", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       super(Material.WOOD);
       setRegistryName("pinelog");
       setUnlocalizedName("pinelog");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorPinelog.class
