 ...
 public class MCreatorBPrairie
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bprairie")
   public static final BiomeGenCustom biome = null;
   
   public MCreatorBPrairie(Elementsbyg instance) {
     super(instance, 1293);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Prairie")).setRainfall(0.3F).setBaseHeight(0.4F).setWaterColor(-14857549).setHeightVariation(0.1F)
           .setTemperature(0.85F));
       setRegistryName("bprairie");
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new MCreatorBPrairie.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorBPrairie.class
