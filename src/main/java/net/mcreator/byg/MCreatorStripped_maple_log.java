 ...
 public class MCreatorStripped_maple_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_maple_log")
   public static final Block block = null;
   
   public MCreatorStripped_maple_log(Elementsbyg instance) {
     super(instance, 1523);
   }
   ...
   public void registerModels(ModelRegistryEvent event) {
     ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("byg:stripped_maple_log", "inventory"));
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public BlockCustom() {
       ...
       setUnlocalizedName("stripped_maple_log");
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorStripped_maple_log.class
