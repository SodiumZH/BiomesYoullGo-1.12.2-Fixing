 ...
 public class MCreatorSandygrass
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:sandygrass")
   public static final Block block = null;
   
   public MCreatorSandygrass(Elementsbyg instance) {
     super(instance, 1069);
   }
     ...
     for (int i = 0; i < 32; i++) {
       ...
       (new WorldGenMinable(block.getDefaultState(), 32, new Predicate<IBlockState>() {
             public boolean apply(IBlockState blockAt) {
               ...
               if (blockAt.getBlock() == MCreatorHardeneddirt.block.getDefaultState().getBlock())
                 blockCriteria = true; 
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(MCreatorSandydirt.block, 1));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\MCreatorSandygrass.class
