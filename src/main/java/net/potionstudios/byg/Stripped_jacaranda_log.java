 ...
 public class Stripped_jacaranda_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_jacaranda_log")
   public static final Block block = null;
   
   public Stripped_jacaranda_log(Elementsbyg instance) {
     super(instance, 1520);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_jacaranda_log.class
