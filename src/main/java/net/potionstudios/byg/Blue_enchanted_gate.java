 ...
 public class Blue_enchanted_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blue_enchanted_gate")
   public static final Block block = null;
   
   public Blue_enchanted_gate(Elementsbyg instance) {
     super(instance, 2120);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       BlueenchantedgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Blue_enchanted_gate.class
