 ...
 public class BMeadow
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bmeadow")
   public static final BiomeGenCustom biome = null;
   
   public BMeadow(Elementsbyg instance) {
     super(instance, 201);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.topBlock = Meadowgrass.block.getDefaultState();
       this.fillerBlock = Meadowdirt.block.getDefaultState();
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Meadowgrass.block.getDefaultState().getBlock() && ground != Meadowdirt.block.getDefaultState()
           .getBlock()) || (ground2 != Meadowgrass.block.getDefaultState().getBlock() && ground2 != Meadowdirt.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Meadowdirt.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Meadowgrass.block.getDefaultState().getBlock() || blockType == Meadowdirt.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Meadowdirt.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Meadowdirt.block.getDefaultState());
       }
     }
