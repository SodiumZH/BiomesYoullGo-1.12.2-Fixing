 ...
 public class BorealTree5 extends Elementsbyg.ModElement {
   public BorealTree5(Elementsbyg instance) {
     super(instance, 218);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = Peatgrass.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       if (!blockCriteria)
         return; 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BorealTree5.class
