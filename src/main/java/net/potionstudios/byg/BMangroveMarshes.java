 ...
 public class BMangroveMarshes
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bmangrovemarshes")
   public static final BiomeGenCustom biome = null;
   
   public BMangroveMarshes(Elementsbyg instance) {
     super(instance, 188);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.topBlock = Whitesand.block.getDefaultState();
       this.fillerBlock = Whitesand.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BMangroveMarshes.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Whitesand.block.getDefaultState().getBlock() && ground != Whitesand.block.getDefaultState()
           .getBlock()) || (ground2 != Whitesand.block.getDefaultState().getBlock() && ground2 != Whitesand.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Whitesand.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Whitesand.block.getDefaultState().getBlock() || blockType == Whitesand.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Whitesand.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Whitesand.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BMangroveMarshes.class
