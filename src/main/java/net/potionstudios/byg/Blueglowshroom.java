 ...
 public class Blueglowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blueglowshroom")
   public static final Block block = null;
   
   public Blueglowshroom(Elementsbyg instance) {
     super(instance, 1313);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Blueglowshroomitem.block, 4));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Blueglowshroom.class
