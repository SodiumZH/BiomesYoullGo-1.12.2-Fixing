 ...
 public class Cikasapling
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:cikasapling")
   public static final Block block = null;
   
   public Cikasapling(Elementsbyg instance) {
     super(instance, 539);
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       CikasaplingUpdateTick.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       CikasaplingOnBlockRightclicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Cikasapling.class
