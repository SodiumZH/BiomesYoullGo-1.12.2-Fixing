 ...
 public class Stripped_willow_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_willow_log")
   public static final Block block = null;
   
   public Stripped_willow_log(Elementsbyg instance) {
     super(instance, 1539);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_willow_log.class
