 ...
 public class Cherry_gate_closed extends Elementsbyg.ModElement {
   @ObjectHolder("byg:cherry_gate_closed")
   public static final Block block = null;
   
   public Cherry_gate_closed(Elementsbyg instance) {
     super(instance, 2123);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(Cherry_gate.block, 1);
     }
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Cherry_gate.block, 1));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       CherrygateclosedOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Cherry_gate_closed.class
