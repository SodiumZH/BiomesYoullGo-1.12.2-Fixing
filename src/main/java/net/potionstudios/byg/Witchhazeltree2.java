 ...
 public class Witchhazeltree2 extends Elementsbyg.ModElement {
   public Witchhazeltree2(Elementsbyg instance) {
     super(instance, 844);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 200000) {
       ...
       IBlockState require = Peatdirt.block.getDefaultState();
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Witchhazeltree2.class
