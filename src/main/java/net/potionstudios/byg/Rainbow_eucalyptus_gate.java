 ...
 public class Rainbow_eucalyptus_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rainbow_eucalyptus_gate")
   public static final Block block = null;
   
   public Rainbow_eucalyptus_gate(Elementsbyg instance) {
     super(instance, 2156);
   }
   ...
   public static class BlockCustom
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       RainboweucalyptusgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Rainbow_eucalyptus_gate.class
