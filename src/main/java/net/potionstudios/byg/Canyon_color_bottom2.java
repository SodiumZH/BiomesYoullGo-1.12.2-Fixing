 ...
 public class Canyon_color_bottom2 extends Elementsbyg.ModElement {
   public Canyon_color_bottom2(Elementsbyg instance) {
     super(instance, 2401);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 500000) {
       ...
       IBlockState require = Red_cracked_sand.block.getDefaultState();
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Canyon_color_bottom2.class
