 ...
 public class Medium_blue_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:medium_blue_glowshroom")
   public static final Block block = null;
   
   public Medium_blue_glowshroom(Elementsbyg instance) {
     super(instance, 1317);
   }
   ...
   public static class BlockCustom
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Blueglowshroomitem.block, 3));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       MediumblueglowshroomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Medium_blue_glowshroom.class
