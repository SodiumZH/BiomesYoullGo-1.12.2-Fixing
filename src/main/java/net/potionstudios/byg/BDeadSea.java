 ...
 public class BDeadSea
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bdeadsea")
   public static final BiomeGenCustom biome = null;
   
   public BDeadSea(Elementsbyg instance) {
     super(instance, 403);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.topBlock = Blacksand.block.getDefaultState();
       this.fillerBlock = Blacksand.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BDeadSea.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Blacksand.block.getDefaultState().getBlock() && ground != Blacksand.block.getDefaultState()
           .getBlock()) || (ground2 != Blacksand.block.getDefaultState().getBlock() && ground2 != Blacksand.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Blacksand.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Blacksand.block.getDefaultState().getBlock() || blockType == Blacksand.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Blacksand.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Blacksand.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BDeadSea.class
