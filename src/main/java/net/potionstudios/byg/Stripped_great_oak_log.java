 ...
 public class Stripped_great_oak_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_great_oak_log")
   public static final Block block = null;
   
   public Stripped_great_oak_log(Elementsbyg instance) {
     super(instance, 1517);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_great_oak_log.class
