 ...
 public class Rocky_grass_alps
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rocky_grass_alps")
   public static final Block block = null;
   
   public Rocky_grass_alps(Elementsbyg instance) {
     super(instance, 2337);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(Rocky_grass.block, 1);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       RockygrassalpsUpdateTick.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Rocky_grass_alps.class
