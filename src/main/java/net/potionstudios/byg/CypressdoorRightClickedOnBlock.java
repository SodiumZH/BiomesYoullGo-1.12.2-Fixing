 ...
 public class CypressdoorRightClickedOnBlock extends Elementsbyg.ModElement {
   ...
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     ...
     if (!((entity instanceof EntityPlayer) ? ((EntityPlayer)entity).capabilities.isCreativeMode : false)) {
       ...
       world.setBlockState(new BlockPos(x, y + 1, z), Cypress_door_bottom.block.getDefaultState(), 3);
       world.setBlockState(new BlockPos(x, y + 2, z), Cypress_door_top.block.getDefaultState(), 3);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\CypressdoorRightClickedOnBlock.class
