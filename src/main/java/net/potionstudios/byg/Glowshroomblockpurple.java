 ...
 public class Glowshroomblockpurple
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:glowshroomblockpurple")
   public static final Block block = null;
   
   public Glowshroomblockpurple(Elementsbyg instance) {
     super(instance, 62);
   }
   ...
   public static class BlockCustom
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Purpleglowshroomitem.block, 1));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Glowshroomblockpurple.class
