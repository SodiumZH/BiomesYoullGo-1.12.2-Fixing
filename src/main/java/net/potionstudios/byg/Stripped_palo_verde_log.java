 ...
 public class Stripped_palo_verde_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_palo_verde_log")
   public static final Block block = null;
   
   public Stripped_palo_verde_log(Elementsbyg instance) {
     super(instance, 1530);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_palo_verde_log.class
