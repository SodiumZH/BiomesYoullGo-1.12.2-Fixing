 ...
 public class Baobab_door_open_bottom
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:baobab_door_open_bottom")
   public static final Block block = null;
   
   public Baobab_door_open_bottom(Elementsbyg instance) {
     super(instance, 1766);
   }
   ...
   public static class BlockCustom
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       BaobabdooropenbottomNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       BaobabdooropenbottomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Baobab_door_open_bottom.class
