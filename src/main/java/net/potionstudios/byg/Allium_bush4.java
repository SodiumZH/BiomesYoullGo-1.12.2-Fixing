 ...
 public class Allium_bush4
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:allium_bush4")
   public static final Block block = null;
   
   public Allium_bush4(Elementsbyg instance) {
     super(instance, 1288);
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(Allium_bush.block, 1);
     }
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Allium_bush.block, 1));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Allium_bush4.class
