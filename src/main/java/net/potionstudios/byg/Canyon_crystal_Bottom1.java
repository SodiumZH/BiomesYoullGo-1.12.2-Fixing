 ...
 public class Canyon_crystal_Bottom1 extends Elementsbyg.ModElement {
   public Canyon_crystal_Bottom1(Elementsbyg instance) {
     super(instance, 2402);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       IBlockState require = Cracked_sand.block.getDefaultState();
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Canyon_crystal_Bottom1.class
