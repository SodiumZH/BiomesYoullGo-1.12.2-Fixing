 ...
 public class Stripped_baobab_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_baobab_log")
   public static final Block block = null;
   
   public Stripped_baobab_log(Elementsbyg instance) {
     super(instance, 1508);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_baobab_log.class
