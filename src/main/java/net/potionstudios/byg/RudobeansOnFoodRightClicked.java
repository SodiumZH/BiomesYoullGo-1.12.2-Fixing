   ...
   extends Elementsbyg.ModElement
 {
   ...
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     ...
     if (((entity instanceof EntityLivingBase) ? ((EntityLivingBase)entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() == (new ItemStack(Rudobeans.block, 1))
       .getItem() && (
       (world.getBlockState(new BlockPos(x, y, z)).getBlock() == Blocks.FARMLAND.getDefaultState().getBlock()) ? true : false) == true) {
       if (entity instanceof EntityPlayer)
         ((EntityPlayer)entity).inventory.clearMatchingItems((new ItemStack(Rudobeans.block, 1)).getItem(), -1, 1, null); 
       world.setBlockState(new BlockPos(x, y + 1, z), Rudostage0.block.getDefaultState(), 3);
     } 
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\RudobeansOnFoodRightClicked.class
