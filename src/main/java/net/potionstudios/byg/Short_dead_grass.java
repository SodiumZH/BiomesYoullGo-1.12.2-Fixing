 ...
 public class Short_dead_grass extends Elementsbyg.ModElement {
   @ObjectHolder("byg:short_dead_grass")
   public static final Block block = null;
   
   public Short_dead_grass(Elementsbyg instance) {
     super(instance, 1254);
   }
           ...
           public boolean generate(World world, Random random, BlockPos pos) {
             for (int i = 0; i < 20; i++) {
               ...
               if (world.isAirBlock(blockpos1)) {
                 ...
                 j = Math.min(1, j);
                 for (int k = 0; k < j; k++) {
                   if (((BlockReed)Short_dead_grass.block).canBlockStay(world, blockpos1))
                     world.setBlockState(blockpos1.up(k), Short_dead_grass.block.getDefaultState(), 2); 
                 } 
               } 
             }  return true;
           }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == Short_dead_grass.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       if ((world.getBlockState(pos.down()).getBlock() == Short_dead_grass.block || checkForDrop(world, pos, state)) && 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Short_dead_grass.class
