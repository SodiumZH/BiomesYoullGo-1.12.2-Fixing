 ...
 public class Blufftree1 extends Elementsbyg.ModElement {
   public Blufftree1(Elementsbyg instance) {
     super(instance, 1464);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       IBlockState require = Rocky_grass.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = Rocky_grass_alps.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       if (!blockCriteria)
         return; 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Blufftree1.class
