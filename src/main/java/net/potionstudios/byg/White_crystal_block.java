 ...
 public class White_crystal_block
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:white_crystal_block")
   public static final Block block = null;
   
   public White_crystal_block(Elementsbyg instance) {
     super(instance, 2378);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(White_crystals.block, 3));
     }
     ...
     public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
       ...
       WhitecrystalblockBlockDestroyedByPlayer.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\White_crystal_block.class
