 ...
 public class PurpleglowshroomitemRightClickedOnBlock extends Elementsbyg.ModElement {
   public PurpleglowshroomitemRightClickedOnBlock(Elementsbyg instance) {
     super(instance, 2414);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\PurpleglowshroomitemRightClickedOnBlock.class
