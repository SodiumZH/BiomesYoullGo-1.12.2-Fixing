 ...
 public class BQuagmire
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bquagmire")
   public static final BiomeGenCustom biome = null;
   
   public BQuagmire(Elementsbyg instance) {
     super(instance, 211);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.topBlock = Mudblock.block.getDefaultState();
       this.fillerBlock = Mudblock.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BQuagmire.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Mudblock.block.getDefaultState().getBlock() && ground != Mudblock.block.getDefaultState()
           .getBlock()) || (ground2 != Mudblock.block.getDefaultState().getBlock() && ground2 != Mudblock.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Mudblock.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Mudblock.block.getDefaultState().getBlock() || blockType == Mudblock.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Mudblock.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Mudblock.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BQuagmire.class
