 ...
 public class Small_purple_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:small_purple_glowshroom")
   public static final Block block = null;
   
   public Small_purple_glowshroom(Elementsbyg instance) {
     super(instance, 1321);
   }
   ...
   public static class BlockCustom
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Purpleglowshroomitem.block, 2));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       SmallpurpleglowshroomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Small_purple_glowshroom.class
