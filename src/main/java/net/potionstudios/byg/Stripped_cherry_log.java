 ...
 public class Stripped_cherry_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_cherry_log")
   public static final Block block = null;
   
   public Stripped_cherry_log(Elementsbyg instance) {
     super(instance, 1505);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_cherry_log.class
