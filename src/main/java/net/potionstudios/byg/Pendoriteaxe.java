 ...
 public class Pendoriteaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:pendoriteaxe")
   public static final Item block = null;
   
   public Pendoriteaxe(Elementsbyg instance) {
     super(instance, 519);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemToolCustom() {
         ...
         }).setUnlocalizedName("pendoriteaxe").setRegistryName("pendoriteaxe")).setCreativeTab(BYGTab.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Pendoriteaxe.class
