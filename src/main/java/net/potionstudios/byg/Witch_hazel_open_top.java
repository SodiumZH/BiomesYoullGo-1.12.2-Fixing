 ...
 public class Witch_hazel_open_top
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:witch_hazel_open_top")
   public static final Block block = null;
   
   public Witch_hazel_open_top(Elementsbyg instance) {
     super(instance, 1905);
   }
   ...
   public static class BlockCustom
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       WitchhazelopentopNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       WitchhazelopentopOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Witch_hazel_open_top.class
