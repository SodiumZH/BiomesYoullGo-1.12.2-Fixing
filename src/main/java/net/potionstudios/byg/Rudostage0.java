 ...
 public class Rudostage0 extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rudostage0")
   public static final Block block = null;
   
   public Rudostage0(Elementsbyg instance) {
     super(instance, 852);
   }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == Rudostage0.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       Rudostage0UpdateTick.executeProcedure($_dependencies);
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       Rudostage0OnBlockRightclicked.executeProcedure($_dependencies);
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Rudobeans.block, 1));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Rudostage0.class
