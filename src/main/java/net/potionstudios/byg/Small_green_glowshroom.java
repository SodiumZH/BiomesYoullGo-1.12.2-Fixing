 ...
 public class Small_green_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:small_green_glowshroom")
   public static final Block block = null;
   
   public Small_green_glowshroom(Elementsbyg instance) {
     super(instance, 1322);
   }
   ...
   public static class BlockCustom
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Greenglowshroomitem.block, 2));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       SmallgreenglowshroomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Small_green_glowshroom.class
