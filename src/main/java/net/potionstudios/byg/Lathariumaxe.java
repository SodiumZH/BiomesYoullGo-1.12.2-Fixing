 ...
 public class Lathariumaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:lathariumaxe")
   public static final Item block = null;
   
   public Lathariumaxe(Elementsbyg instance) {
     super(instance, 935);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemToolCustom() {
         ...
         }).setUnlocalizedName("lathariumaxe").setRegistryName("lathariumaxe")).setCreativeTab(BYGTab.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Lathariumaxe.class
