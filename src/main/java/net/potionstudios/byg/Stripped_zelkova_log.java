 ...
 public class Stripped_zelkova_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_zelkova_log")
   public static final Block block = null;
   
   public Stripped_zelkova_log(Elementsbyg instance) {
     super(instance, 1542);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_zelkova_log.class
