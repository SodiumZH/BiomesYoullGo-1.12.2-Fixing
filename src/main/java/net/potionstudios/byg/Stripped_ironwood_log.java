 ...
 public class Stripped_ironwood_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_ironwood_log")
   public static final Block block = null;
   
   public Stripped_ironwood_log(Elementsbyg instance) {
     super(instance, 1569);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_ironwood_log.class
