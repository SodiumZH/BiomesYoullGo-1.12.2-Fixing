 ...
 public class Blue_enchanted_door_bottom
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blue_enchanted_door_bottom")
   public static final Block block = null;
   
   public Blue_enchanted_door_bottom(Elementsbyg instance) {
     super(instance, 1777);
   }
   ...
   public static class BlockCustom
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       BlueenchanteddoorbottomNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       BlueenchanteddoorbottomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Blue_enchanted_door_bottom.class
