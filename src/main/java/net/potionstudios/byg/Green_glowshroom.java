 ...
 public class Green_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:green_glowshroom")
   public static final Block block = null;
   
   public Green_glowshroom(Elementsbyg instance) {
     super(instance, 1315);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Greenglowshroomitem.block, 4));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Green_glowshroom.class
