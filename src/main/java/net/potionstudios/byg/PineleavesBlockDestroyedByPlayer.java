 ...
 public class PineleavesBlockDestroyedByPlayer extends Elementsbyg.ModElement {
   public PineleavesBlockDestroyedByPlayer(Elementsbyg instance) {
     super(instance, 620);
   }
   ...
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     ...
     if (((entity instanceof EntityLivingBase) ? ((EntityLivingBase)entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() == (new ItemStack((Item)Items.SHEARS, 1))
       .getItem()) {
       if (!world.isRemote) {
         EntityItem entityToSpawn = new EntityItem(world, x, y, z, new ItemStack(Pineleaves.block, 1));
       ...
       !world.isRemote) {
       EntityItem entityToSpawn = new EntityItem(world, x, y, z, new ItemStack(Pinesapling.block, 1));
       entityToSpawn.setPickupDelay(10);
       world.spawnEntity((Entity)entityToSpawn);
     } 
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\PineleavesBlockDestroyedByPlayer.class
