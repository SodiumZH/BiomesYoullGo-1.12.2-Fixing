 ...
 public class Stripped_cypress_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_cypress_log")
   public static final Block block = null;
   
   public Stripped_cypress_log(Elementsbyg instance) {
     super(instance, 1566);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_cypress_log.class
