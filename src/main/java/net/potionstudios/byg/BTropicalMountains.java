 ...
 public class BTropicalMountains
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:btropicalmountains")
   public static final BiomeGenCustom biome = null;
   
   public BTropicalMountains(Elementsbyg instance) {
     super(instance, 913);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.topBlock = Overgrown_stone.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BTropicalMountains.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random par2Random, BlockPos pos) {
       ...
       if (ground != Overgrown_stone.block.getDefaultState().getBlock() && ground != Blocks.STONE.getStateFromMeta(0).getBlock() && ground2 != Overgrown_stone.block
     ...
     protected boolean canGrowInto(Block blockType) {
       ...
       return (material == Material.AIR || blockType == Overgrown_stone.block.getDefaultState().getBlock() || blockType == Blocks.STONE
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BTropicalMountains.class
