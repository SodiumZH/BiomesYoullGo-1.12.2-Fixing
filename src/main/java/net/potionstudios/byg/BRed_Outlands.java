 ...
 public class BRed_Outlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bred_outlands")
   public static final BiomeGenCustom biome = null;
   
   public BRed_Outlands(Elementsbyg instance) {
     super(instance, 1373);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.fillerBlock = Red_cracked_sand.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BRed_Outlands.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Red_cracked_sand.block.getDefaultState().getBlock() && ground != Red_cracked_sand.block
           .getDefaultState().getBlock()) || (ground2 != Red_cracked_sand.block.getDefaultState().getBlock() && ground2 != Red_cracked_sand.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Red_cracked_sand.block.getDefaultState(), 2); int genh;
     ...
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Red_cracked_sand.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Red_cracked_sand.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BRed_Outlands.class
