 ...
 public class Stripped_witch_hazel_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_witch_hazel_log")
   public static final Block block = null;
   
   public Stripped_witch_hazel_log(Elementsbyg instance) {
     super(instance, 1551);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_witch_hazel_log.class
