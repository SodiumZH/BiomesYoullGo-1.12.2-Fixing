 ...
 public class BOutlands
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:boutlands")
   public static final BiomeGenCustom biome = null;
   
   public BOutlands(Elementsbyg instance) {
     super(instance, 1372);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.topBlock = Cracked_sand.block.getDefaultState();
       this.fillerBlock = Cracked_sand.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BOutlands.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Cracked_sand.block.getDefaultState().getBlock() && ground != Cracked_sand.block
           .getDefaultState().getBlock()) || (ground2 != Cracked_sand.block.getDefaultState().getBlock() && ground2 != Cracked_sand.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Cracked_sand.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Cracked_sand.block.getDefaultState().getBlock() || blockType == Cracked_sand.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Cracked_sand.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Cracked_sand.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BOutlands.class
