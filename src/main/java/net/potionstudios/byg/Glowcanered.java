 ...
 public class Glowcanered extends Elementsbyg.ModElement {
   @ObjectHolder("byg:glowcanered")
   public static final Block block = null;
   
   public Glowcanered(Elementsbyg instance) {
     super(instance, 113);
   }
           ...
           public boolean generate(World world, Random random, BlockPos pos) {
             for (int i = 0; i < 20; i++) {
               ...
               if (world.isAirBlock(blockpos1)) {
                 ...
                 j = Math.min(5, j);
                 for (int k = 0; k < j; k++) {
                   if (((BlockReed)Glowcanered.block).canBlockStay(world, blockpos1))
                     world.setBlockState(blockpos1.up(k), Glowcanered.block.getDefaultState(), 2); 
                 } 
               } 
             }  return true;
           }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == Glowcanered.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       if ((world.getBlockState(pos.down()).getBlock() == Glowcanered.block || checkForDrop(world, pos, state)) && 
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Glowcanestalkred.block, 1));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Glowcanered.class
