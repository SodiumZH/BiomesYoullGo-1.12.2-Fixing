 ...
 public class Blue_enchanted_door_open_top
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blue_enchanted_door_open_top")
   public static final Block block = null;
   
   public Blue_enchanted_door_open_top(Elementsbyg instance) {
     super(instance, 1780);
   }
   ...
   public static class BlockCustom
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       BlueenchanteddooropentopNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       BlueenchanteddooropentopOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Blue_enchanted_door_open_top.class
