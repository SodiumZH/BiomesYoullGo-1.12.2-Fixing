 ...
 public class BColored_Canyons
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bcolored_canyons")
   public static final BiomeGenCustom biome = null;
   
   public BColored_Canyons(Elementsbyg instance) {
     super(instance, 2398);
   }
   ...
   public void init(FMLInitializationEvent event) {
     BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HOT, BiomeDictionary.Type.DRY, BiomeDictionary.Type.MESA, BiomeDictionary.Type.RARE });
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       super((new Biome.BiomeProperties("Colored Canyons")).setRainfall(0.2F).setBaseHeight(0.0F).setWaterColor(-14329397).setHeightVariation(0.0F)
           .setTemperature(2.0F));
       setRegistryName("bcolored_canyons");
       this.topBlock = Red_cracked_sand.block.getDefaultState();
       this.fillerBlock = Blocks.RED_SANDSTONE.getStateFromMeta(0);
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BColored_Canyons.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Red_cracked_sand.block.getDefaultState().getBlock() && ground != Blocks.RED_SANDSTONE
           .getStateFromMeta(0).getBlock()) || (ground2 != Red_cracked_sand.block.getDefaultState().getBlock() && ground2 != Blocks.RED_SANDSTONE
           .getStateFromMeta(0).getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Blocks.RED_SANDSTONE.getStateFromMeta(0), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Red_cracked_sand.block
         .getDefaultState().getBlock() || blockType == Blocks.RED_SANDSTONE
         .getStateFromMeta(0).getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Blocks.RED_SANDSTONE.getStateFromMeta(0).getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Blocks.RED_SANDSTONE.getStateFromMeta(0));
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BColored_Canyons.class
