 ...
 public class BStellataPasture
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bstellatapasture")
   public static final BiomeGenCustom biome = null;
   
   public BStellataPasture(Elementsbyg instance) {
     super(instance, 194);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.topBlock = Pasturegrass.block.getDefaultState();
       this.fillerBlock = Pasturdirt.block.getDefaultState();
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BStellataPasture.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Pasturegrass.block.getDefaultState().getBlock() && ground != Pasturdirt.block.getDefaultState()
           .getBlock()) || (ground2 != Pasturegrass.block.getDefaultState().getBlock() && ground2 != Pasturdirt.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Pasturdirt.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Pasturegrass.block.getDefaultState().getBlock() || blockType == Pasturdirt.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Pasturdirt.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Pasturdirt.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BStellataPasture.class
