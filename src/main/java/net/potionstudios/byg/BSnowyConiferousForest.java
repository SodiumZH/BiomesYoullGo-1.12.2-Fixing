 ...
 public class BSnowyConiferousForest
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bsnowyconiferousforest")
   public static final BiomeGenCustom biome = null;
   
   public BSnowyConiferousForest(Elementsbyg instance) {
     super(instance, 849);
   }
   ...
   static class BiomeGenCustom extends Biome {
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BSnowyConiferousForest.CustomTree();
     }
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BSnowyConiferousForest.class
