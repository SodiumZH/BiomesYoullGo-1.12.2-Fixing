 ...
 public class Cattail1 extends Elementsbyg.ModElement {
   public Cattail1(Elementsbyg instance) {
     super(instance, 2218);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       IBlockState require = Mudblock.block.getDefaultState();
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Cattail1.class
