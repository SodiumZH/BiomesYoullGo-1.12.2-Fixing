 ...
 public class Witch_hazel_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:witch_hazel_gate")
   public static final Block block = null;
   
   public Witch_hazel_gate(Elementsbyg instance) {
     super(instance, 2165);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       WitchhazelgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Witch_hazel_gate.class
