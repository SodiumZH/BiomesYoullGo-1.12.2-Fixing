 ...
 public class BAlliumFields
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:balliumfields")
   public static final BiomeGenCustom biome = null;
   
   public BAlliumFields(Elementsbyg instance) {
     super(instance, 210);
   }
   ...
   static class BiomeGenCustom extends Biome {
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BAlliumFields.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
         ...
         if (position.getY() < world.getHeight() - height - 1) {
               ...
               for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; i2++) {
                 ...
                 if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || (rand.nextInt(2) != 0 && i4 != 0)) {
                   ...
                   if (state.getBlock().isAir(state, (IBlockAccess)world, blockpos) || state.getBlock().isLeaves(state, (IBlockAccess)world, blockpos) || state
                     ...
                     .getBlock() == Jacarandaleaves.block.getDefaultState().getBlock()) {
                     setBlockAndNotifyAdequately(world, blockpos, Jacarandaleaves.block.getDefaultState());
                   }
                 } 
               } 
             } 
           ...
           for (genh = 0; genh < height; genh++) {
             ...
             if (state.getBlock().isAir(state, (IBlockAccess)world, genhPos) || state.getBlock() == Blocks.AIR.getDefaultState().getBlock() || state
               .getBlock() == Jacarandaleaves.block.getDefaultState().getBlock()) {
               setBlockAndNotifyAdequately(world, position.up(genh), Jacarandalog.block.getDefaultState());
             }
           } 
               ...
               for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                 if (rand.nextInt(4 - hlevel) == 0) {
                   ...
                   setBlockAndNotifyAdequately(world, position
                       .add(enumfacing1.getFrontOffsetX(), height - 5 + hlevel, enumfacing1.getFrontOffsetZ()), Jacarandalog.block
                       .getDefaultState());
                 } 
               } 
             } 
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Jacarandalog.block.getDefaultState().getBlock() || blockType == Jacarandaleaves.block
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BAlliumFields.class
