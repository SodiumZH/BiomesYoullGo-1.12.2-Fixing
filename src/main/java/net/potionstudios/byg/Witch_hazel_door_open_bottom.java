 ...
 public class Witch_hazel_door_open_bottom
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:witch_hazel_door_open_bottom")
   public static final Block block = null;
   
   public Witch_hazel_door_open_bottom(Elementsbyg instance) {
     super(instance, 1882);
   }
   ...
   public static class BlockCustom
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(Witch_hazel_door.block, 1);
     }
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Witch_hazel_door.block, 1));
     }
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       WitchhazeldooropenbottomNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       WitchhazeldooropenbottomOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Witch_hazel_door_open_bottom.class
