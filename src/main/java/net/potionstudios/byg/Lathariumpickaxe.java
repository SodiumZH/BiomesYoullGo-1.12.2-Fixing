 ...
 public class Lathariumpickaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:lathariumpickaxe")
   public static final Item block = null;
   
   public Lathariumpickaxe(Elementsbyg instance) {
     super(instance, 934);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemPickaxe(EnumHelper.addToolMaterial("LATHARIUMPICKAXE", 7, 950, 9.0F, 2.0F, 8)) {
         ...
         }).setUnlocalizedName("lathariumpickaxe").setRegistryName("lathariumpickaxe")).setCreativeTab(BYGTab.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Lathariumpickaxe.class
