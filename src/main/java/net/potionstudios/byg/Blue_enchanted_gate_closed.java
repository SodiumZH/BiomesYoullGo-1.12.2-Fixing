 ...
 public class Blue_enchanted_gate_closed extends Elementsbyg.ModElement {
   @ObjectHolder("byg:blue_enchanted_gate_closed")
   public static final Block block = null;
   
   public Blue_enchanted_gate_closed(Elementsbyg instance) {
     super(instance, 2121);
   }
   ...
   public static class BlockCustom
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(Blue_enchanted_gate.block, 1);
     }
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Blue_enchanted_gate.block, 1));
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       BlueenchantedgateclosedOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Blue_enchanted_gate_closed.class
