 ...
 public class Tamrelitebattleaxe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:tamrelitebattleaxe")
   public static final Item block = null;
   
   public Tamrelitebattleaxe(Elementsbyg instance) {
     super(instance, 916);
   }
   ...
   public void initElements() {
     this.elements.items.add(() -> ((Item)(new ItemToolCustom() {
         ...
         }).setUnlocalizedName("tamrelitebattleaxe").setRegistryName("tamrelitebattleaxe")).setCreativeTab(BYGTab.tab));
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Tamrelitebattleaxe.class
