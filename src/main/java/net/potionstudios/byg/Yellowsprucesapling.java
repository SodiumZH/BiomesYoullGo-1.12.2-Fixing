 ...
 public class Yellowsprucesapling
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:yellowsprucesapling")
   public static final Block block = null;
   
   public Yellowsprucesapling(Elementsbyg instance) {
     super(instance, 554);
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       ...
       YellowsprucesaplingUpdateTick.executeProcedure($_dependencies);
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Yellowsprucesapling.class
