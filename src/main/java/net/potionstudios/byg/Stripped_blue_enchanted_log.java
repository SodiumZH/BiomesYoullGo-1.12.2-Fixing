 ...
 public class Stripped_blue_enchanted_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_blue_enchanted_log")
   public static final Block block = null;
   
   public Stripped_blue_enchanted_log(Elementsbyg instance) {
     super(instance, 1511);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_blue_enchanted_log.class
