 ...
 public class Salal_bush_ripe
   extends Elementsbyg.ModElement
 {
   @ObjectHolder("byg:salal_bush_ripe")
   public static final Block block = null;
   
   public Salal_bush_ripe(Elementsbyg instance) {
     super(instance, 2360);
   }
   ...
   public static class BlockCustomFlower extends BlockFlower {
     ...
     public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
       return new ItemStack(Salal_bush.block, 1);
     }
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Salal_berry.block, 2));
     }
   }
 }


/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Salal_bush_ripe.class
