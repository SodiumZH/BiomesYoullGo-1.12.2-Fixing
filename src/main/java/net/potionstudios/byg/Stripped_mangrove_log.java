 ...
 public class Stripped_mangrove_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_mangrove_log")
   public static final Block block = null;
   
   public Stripped_mangrove_log(Elementsbyg instance) {
     super(instance, 1526);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_mangrove_log.class
