 ...
 public class BCrystal_Canyons
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:bcrystal_canyons")
   public static final BiomeGenCustom biome = null;
   
   public BCrystal_Canyons(Elementsbyg instance) {
     super(instance, 2397);
   }
   ...
   static class BiomeGenCustom extends Biome {
     public BiomeGenCustom() {
       ...
       this.fillerBlock = Whitesandstone.block.getDefaultState();
       ...
       //this.spawnableCreatureList.add(new Biome.SpawnListEntry(Petrifiedspider.EntityCustom.class, 40, 1, 5));
     }
     ...
     public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
       return new BCrystal_Canyons.CustomTree();
     }
   }
   ...
   static class CustomTree extends WorldGenAbstractTree {
     ...
     public boolean generate(World world, Random rand, BlockPos position) {
       ...
       if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
         ...
         if ((ground != Cracked_sand.block.getDefaultState().getBlock() && ground != Whitesandstone.block
           .getDefaultState().getBlock()) || (ground2 != Cracked_sand.block.getDefaultState().getBlock() && ground2 != Whitesandstone.block
           .getDefaultState().getBlock()))
           return false; 
         IBlockState state = world.getBlockState(position.down());
         if (position.getY() < world.getHeight() - height - 1) {
           world.setBlockState(position.down(), Whitesandstone.block.getDefaultState(), 2); int genh;
     ...
     protected boolean canGrowInto(Block blockType) {
       return (blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == Blocks.AIR
         .getDefaultState().getBlock() || blockType == Cracked_sand.block.getDefaultState().getBlock() || blockType == Whitesandstone.block
         .getDefaultState().getBlock());
     }
 
     
     protected void setDirtAt(World world, BlockPos pos) {
       if (world.getBlockState(pos).getBlock() != Whitesandstone.block.getDefaultState().getBlock()) {
         setBlockAndNotifyAdequately(world, pos, Whitesandstone.block.getDefaultState());
       }
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\BCrystal_Canyons.class
