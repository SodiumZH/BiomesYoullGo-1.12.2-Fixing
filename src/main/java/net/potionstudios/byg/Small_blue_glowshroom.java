 ...
 public class Small_blue_glowshroom extends Elementsbyg.ModElement {
   @ObjectHolder("byg:small_blue_glowshroom")
   public static final Block block = null;
   
   public Small_blue_glowshroom(Elementsbyg instance) {
     super(instance, 1320);
   }
   ...
   public static class BlockCustom
     ...
     public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
       drops.add(new ItemStack(Blueglowshroomitem.block, 2));
     }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Small_blue_glowshroom.class
