 ...
 public class Stripped_hawthorn_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_hawthorn_log")
   public static final Block block = null;
   
   public Stripped_hawthorn_log(Elementsbyg instance) {
     super(instance, 1560);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_hawthorn_log.class
