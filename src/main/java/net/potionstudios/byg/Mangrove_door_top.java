 ...
 public class Mangrove_door_top
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:mangrove_door_top")
   public static final Block block = null;
   
   public Mangrove_door_top(Elementsbyg instance) {
     super(instance, 1852);
   }
   ...
   public static class BlockCustom extends Block {
     ...
     public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
       ...
       MangrovedoortopNeighbourBlockChanges.executeProcedure($_dependencies);
     }
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       $_dependencies.put("z", Integer.valueOf(z));
       $_dependencies.put("world", world);
       MangrovedoortopOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Mangrove_door_top.class
