 ...
 public class Stripped_redwood_log extends Elementsbyg.ModElement {
   @ObjectHolder("byg:stripped_redwood_log")
   public static final Block block = null;
   
   public Stripped_redwood_log(Elementsbyg instance) {
     super(instance, 1545);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Stripped_redwood_log.class
