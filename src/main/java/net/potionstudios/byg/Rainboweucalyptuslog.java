 ...
 public class Rainboweucalyptuslog extends Elementsbyg.ModElement {
   @ObjectHolder("byg:rainboweucalyptuslog")
   public static final Block block = null;
   
   public Rainboweucalyptuslog(Elementsbyg instance) {
     super(instance, 745);
   }
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Rainboweucalyptuslog.class
