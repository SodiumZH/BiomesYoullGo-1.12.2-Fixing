 ...
 public class Green_enchanted_gate
   extends Elementsbyg.ModElement {
   @ObjectHolder("byg:green_enchanted_gate")
   public static final Block block = null;
   
   public Green_enchanted_gate(Elementsbyg instance) {
     super(instance, 2134);
   }
   ...
   public static class BlockCustom
     ...
     public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
       ...
       GreenenchantedgateOnBlockRightClicked.executeProcedure($_dependencies);
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Green_enchanted_gate.class
