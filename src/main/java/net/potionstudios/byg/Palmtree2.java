 ...
 public class Palmtree2 extends Elementsbyg.ModElement {
   public Palmtree2(Elementsbyg instance) {
     super(instance, 1402);
   }
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 80000) {
       ...
       IBlockState require = Light_blue_sand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = Pink_sand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = Purple_sand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = Whitesand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
       require = Blacksand.block.getDefaultState();
       if (blockAt.getBlock() == require.getBlock())
         blockCriteria = true; 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Palmtree2.class
