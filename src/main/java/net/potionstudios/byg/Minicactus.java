 ...
 public class Minicactus extends Elementsbyg.ModElement {
   @ObjectHolder("byg:minicactus")
   public static final Block block = null;
   
   public Minicactus(Elementsbyg instance) {
     super(instance, 505);
   }
           ...
           public boolean generate(World world, Random random, BlockPos pos) {
             for (int i = 0; i < 20; i++) {
               ...
               if (world.isAirBlock(blockpos1)) {
                 ...
                 j = Math.min(1, j);
                 for (int k = 0; k < j; k++) {
                   if (((BlockReed)Minicactus.block).canBlockStay(world, blockpos1))
                     world.setBlockState(blockpos1.up(k), Minicactus.block.getDefaultState(), 2); 
                 } 
               } 
             }  return true;
           }
   ...
   public static class BlockCustomFlower extends BlockReed {
     ...
     public boolean canPlaceBlockAt(World world, BlockPos pos) {
       ...
       return (block2.canSustainPlant(world.getBlockState(pos.down()), (IBlockAccess)world, pos.down(), EnumFacing.UP, (IPlantable)this) || block2 == Minicactus.block);
     }
     ...
     public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
       if ((world.getBlockState(pos.down()).getBlock() == Minicactus.block || checkForDrop(world, pos, state)) && 
...
/* Location:              H:\eclipse-workspace-19\BiomesYouGo1.7.1-deobf.jar!\net\mcreator\byg\Minicactus.class
